...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-06-2024 a las 21:39:11
...
--
-- Estructura de tabla para la tabla `oc_address`
--
...
--
-- Volcado de datos para la tabla `oc_address`
--
...
(1, 1, 'Miguel', 'Reyes', 'Gamefriend100', 'Agustin Arriaga Rivera #720', '', 'Puruandiro', '58507', 138, 2160, '\"\"', 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_address_format`
--
...
--
-- Volcado de datos para la tabla `oc_address_format`
--
...
--
-- Estructura de tabla para la tabla `oc_antispam`
--
...
--
-- Estructura de tabla para la tabla `oc_api`
--
...
--
-- Volcado de datos para la tabla `oc_api`
--

INSERT INTO `oc_api` (`api_id`, `username`, `key`, `status`, `date_added`, `date_modified`) VALUES
(1, 'Default', '', 1, '2024-05-09 14:59:44', '2024-05-09 14:59:44');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_api_ip`
--
...
--
-- Estructura de tabla para la tabla `oc_api_session`
--
...
--
-- Estructura de tabla para la tabla `oc_article`
--
...
--
-- Estructura de tabla para la tabla `oc_article_comment`
--
...
--
-- Estructura de tabla para la tabla `oc_article_description`
--
...
--
-- Estructura de tabla para la tabla `oc_article_to_layout`
--
...
--
-- Estructura de tabla para la tabla `oc_article_to_store`
--
...
--
-- Estructura de tabla para la tabla `oc_attribute`
--
...
--
-- Volcado de datos para la tabla `oc_attribute`
--
...
--
-- Estructura de tabla para la tabla `oc_attribute_description`
--
...
--
-- Volcado de datos para la tabla `oc_attribute_description`
--
...
--
-- Estructura de tabla para la tabla `oc_attribute_group`
--
...
--
-- Volcado de datos para la tabla `oc_attribute_group`
--
...
--
-- Estructura de tabla para la tabla `oc_attribute_group_description`
--
...
--
-- Volcado de datos para la tabla `oc_attribute_group_description`
--
...
--
-- Estructura de tabla para la tabla `oc_banner`
--
...
--
-- Volcado de datos para la tabla `oc_banner`
--
...
--
-- Estructura de tabla para la tabla `oc_banner_image`
--
...
--
-- Volcado de datos para la tabla `oc_banner_image`
--

INSERT INTO `oc_banner_image` (`banner_image_id`, `banner_id`, `language_id`, `title`, `link`, `image`, `sort_order`) VALUES
(110, 6, 2, 'HP Banner', 'index.php?route=product/manufacturer.info&amp;manufacturer_id=7', 'catalog/D_NQ_NP_717499-MLM72113697935_102023-O.webp', 0),
(127, 8, 2, 'COMPAQ', '', 'catalog/Compaq-logo-2.png', 0),
(128, 8, 2, 'HP', '', 'catalog/hp_logo_PNG2.png', 0),
(129, 8, 2, 'ASUS', '', 'catalog/Asus-Logo-PNG.png', 0),
(130, 8, 2, 'Dell', '', 'catalog/Dell-Logo-PNG.png', 0),
(131, 7, 2, 'iPhone 6', 'index.php?route=product/product&amp;path=57&amp;product_id=49', 'catalog/Digital-laptops-on-transparent-background-PNG.png', 0),
(132, 7, 2, 'MacBookAir', '', 'catalog/pngegg.png', 0),
(133, 7, 2, '12222', '', 'catalog/a7e26edf-2362-4325-81df-cbcc5c2000bb.fd4392ba63e96c1c40b093aae4386a41.webp', 0),
(134, 7, 2, '2222', '', 'catalog/D_NQ_NP_924611-MLU69395908864_052023-O.webp', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_cart`
--
...
--
-- Estructura de tabla para la tabla `oc_category`
--
...
--
-- Volcado de datos para la tabla `oc_category`
--

INSERT INTO `oc_category` (`category_id`, `image`, `parent_id`, `top`, `column`, `sort_order`, `status`, `date_added`, `date_modified`) VALUES
(60, 'catalog/accesorios-gaming-3084392.webp', 0, 1, 1, 0, 1, '2024-05-09 11:31:52', '2024-05-09 11:32:22'),
(61, 'catalog/D_NQ_NP_654080-MLA47781882564_102021-O.webp', 0, 1, 1, 0, 1, '2024-05-09 11:43:56', '2024-05-09 11:43:56'),
(62, 'catalog/D_NQ_NP_707983-MLA71875543786_092023-O.webp', 0, 1, 1, 0, 1, '2024-05-09 12:00:43', '2024-05-09 12:01:04');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_category_description`
--
...
--
-- Volcado de datos para la tabla `oc_category_description`
--

INSERT INTO `oc_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(60, 2, 'Computadoras', '&lt;p&gt;Computadoras de escritorio, portatiles y accesorios.&lt;/p&gt;', 'Electronicos', '', ''),
(61, 2, 'Moviles', '&lt;p&gt;Dispositivos Moviles de multiples marcas&lt;/p&gt;', 'Electronicos', '', ''),
(62, 2, 'Accesorios', '', 'Electronicos', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_category_filter`
--
...
--
-- Estructura de tabla para la tabla `oc_category_path`
--
...
--
-- Volcado de datos para la tabla `oc_category_path`
--
...
--
-- Estructura de tabla para la tabla `oc_category_to_layout`
--
...
--
-- Volcado de datos para la tabla `oc_category_to_layout`
--
...
--
-- Estructura de tabla para la tabla `oc_category_to_store`
--
...
--
-- Volcado de datos para la tabla `oc_category_to_store`
--
...
--
-- Estructura de tabla para la tabla `oc_country`
--
...
--
-- Volcado de datos para la tabla `oc_country`
--
...
(4, '-10% Discount', '2222', 'P', 10.0000, 1, 1, 0.0000, '2014-01-01', '2025-01-01', 100, 100, 1, '2009-01-27 13:55:03'),
...
--
-- Estructura de tabla para la tabla `oc_coupon_category`
--
...
--
-- Estructura de tabla para la tabla `oc_coupon_history`
--
...
--
-- Estructura de tabla para la tabla `oc_coupon_product`
--
...
--
-- Estructura de tabla para la tabla `oc_cron`
--
...
--
-- Volcado de datos para la tabla `oc_cron`
--
...
--
-- Estructura de tabla para la tabla `oc_currency`
--
...
--
-- Volcado de datos para la tabla `oc_currency`
--

INSERT INTO `oc_currency` (`currency_id`, `title`, `code`, `symbol_left`, `symbol_right`, `decimal_place`, `value`, `status`, `date_modified`) VALUES
(1, 'Pound Sterling', 'GBP', '£', '', 2, 0.73819193, 0, '2024-05-13 10:57:20'),
(2, 'US Dollar', 'USD', '$', '', 2, 1.00000000, 0, '2024-05-13 10:57:20'),
(3, 'Euro', 'EUR', '', '€', 2, 0.85813320, 0, '2024-05-13 10:57:20'),
(4, 'Hong Kong Dollar', 'HKD', 'HK$', '', 2, 7.23655150, 0, '2024-05-13 10:57:20'),
(5, 'Indian Rupee', 'INR', '₹', '', 2, 77.34612009, 0, '2024-05-13 10:57:20'),
(6, 'Russian Ruble', 'RUB', '', '₽', 2, 56.40360000, 0, '2018-02-16 12:00:00'),
(7, 'Chinese Yuan Renminbi', 'CNY', '¥', '', 2, 6.70159126, 0, '2024-05-13 10:57:20'),
(8, 'Australian Dollar', 'AUD', '$', '', 2, 1.39918619, 0, '2024-05-13 10:57:20'),
(9, '$ Pesos', 'MXN', '$', '', 0, 15.50758257, 1, '2024-05-13 10:57:20');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_customer`
--
...
--
-- Volcado de datos para la tabla `oc_customer`
--
...
(1, 1, 0, 2, 'Miguel', 'Reyes', 'mr8942734@gmail.com', '', '$2y$10$wLQUm/tPgTjRxzHHyPuq9.MG0pTKaUOiXgFoyCLLtLCpPFcDHXGfG', '\"\"', 0, '::1', 1, 0, '', '', '2024-05-09 09:30:34');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_customer_activity`
--
...
--
-- Estructura de tabla para la tabla `oc_customer_affiliate`
--
...
--
-- Estructura de tabla para la tabla `oc_customer_affiliate_report`
--
...
--
-- Estructura de tabla para la tabla `oc_customer_approval`
--
...
--
-- Estructura de tabla para la tabla `oc_customer_group`
--
...
--
-- Volcado de datos para la tabla `oc_customer_group`
--
...
--
-- Estructura de tabla para la tabla `oc_customer_group_description`
--
...
--
-- Volcado de datos para la tabla `oc_customer_group_description`
--
...
--
-- Estructura de tabla para la tabla `oc_customer_history`
--
...
--
-- Estructura de tabla para la tabla `oc_customer_ip`
--
...
--
-- Volcado de datos para la tabla `oc_customer_ip`
--

INSERT INTO `oc_customer_ip` (`customer_ip_id`, `customer_id`, `store_id`, `ip`, `country`, `date_added`) VALUES
(1, 1, 0, '::1', '', '2024-05-09 09:30:34');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_customer_login`
--
...
--
-- Estructura de tabla para la tabla `oc_customer_online`
--
...
--
-- Estructura de tabla para la tabla `oc_customer_reward`
--
...
--
-- Estructura de tabla para la tabla `oc_customer_search`
--
...
--
-- Estructura de tabla para la tabla `oc_customer_transaction`
--
...
--
-- Estructura de tabla para la tabla `oc_customer_wishlist`
--
...
--
-- Estructura de tabla para la tabla `oc_custom_field`
--
...
--
-- Volcado de datos para la tabla `oc_custom_field`
--
...
--
-- Estructura de tabla para la tabla `oc_custom_field_customer_group`
--
...
--
-- Volcado de datos para la tabla `oc_custom_field_customer_group`
--
...
--
-- Estructura de tabla para la tabla `oc_custom_field_description`
--
...
--
-- Volcado de datos para la tabla `oc_custom_field_description`
--
...
--
-- Estructura de tabla para la tabla `oc_custom_field_value`
--
...
--
-- Volcado de datos para la tabla `oc_custom_field_value`
--
...
--
-- Estructura de tabla para la tabla `oc_custom_field_value_description`
--
...
--
-- Volcado de datos para la tabla `oc_custom_field_value_description`
--
...
--
-- Estructura de tabla para la tabla `oc_download`
--
...
--
-- Estructura de tabla para la tabla `oc_download_description`
--
...
--
-- Estructura de tabla para la tabla `oc_download_report`
--
...
--
-- Estructura de tabla para la tabla `oc_event`
--
...
--
-- Volcado de datos para la tabla `oc_event`
--
...
--
-- Estructura de tabla para la tabla `oc_extension`
--
...
--
-- Volcado de datos para la tabla `oc_extension`
--
...
(47, 'opencart', 'payment', 'cheque');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_extension_install`
--
...
--
-- Volcado de datos para la tabla `oc_extension_install`
--
...
(2, 0, 0, 'OpenCart Language Example', 'oc_language_example', '1.0', 'OpenCart Ltd', 'https://www.opencart.com', 0, '2024-05-09 09:25:16'),
(3, 0, 0, 'OpenCart Payment Example', 'oc_payment_example', '1.0', 'OpenCart Ltd', 'https://www.opencart.com', 0, '2024-05-09 09:25:16'),
(4, 0, 0, 'OpenCart Theme Example', 'oc_theme_example', '1.0', 'OpenCart Ltd', 'https://www.opencart.com', 0, '2024-05-09 09:25:16');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_extension_path`
--
...
--
-- Volcado de datos para la tabla `oc_extension_path`
--
...
--
-- Estructura de tabla para la tabla `oc_filter`
--
...
--
-- Volcado de datos para la tabla `oc_filter`
--
...
--
-- Estructura de tabla para la tabla `oc_filter_description`
--
...
--
-- Volcado de datos para la tabla `oc_filter_description`
--
...
--
-- Estructura de tabla para la tabla `oc_filter_group`
--
...
--
-- Volcado de datos para la tabla `oc_filter_group`
--
...
--
-- Estructura de tabla para la tabla `oc_filter_group_description`
--
...
--
-- Volcado de datos para la tabla `oc_filter_group_description`
--
...
--
-- Estructura de tabla para la tabla `oc_gdpr`
--
...
--
-- Estructura de tabla para la tabla `oc_geo_zone`
--
...
--
-- Volcado de datos para la tabla `oc_geo_zone`
--
...
--
-- Estructura de tabla para la tabla `oc_information`
--
...
--
-- Volcado de datos para la tabla `oc_information`
--
...
--
-- Estructura de tabla para la tabla `oc_information_description`
--
...
--
-- Volcado de datos para la tabla `oc_information_description`
--
...
--
-- Estructura de tabla para la tabla `oc_information_to_layout`
--
...
--
-- Estructura de tabla para la tabla `oc_information_to_store`
--
...
--
-- Volcado de datos para la tabla `oc_information_to_store`
--
...
--
-- Estructura de tabla para la tabla `oc_language`
--
...
--
-- Volcado de datos para la tabla `oc_language`
--

INSERT INTO `oc_language` (`language_id`, `name`, `code`, `locale`, `extension`, `sort_order`, `status`) VALUES
(2, 'Español', 'es-es', 'es_ES.UTF-8,es_ES,es-es,es_es', '', 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_layout`
--
...
--
-- Volcado de datos para la tabla `oc_layout`
--
...
--
-- Estructura de tabla para la tabla `oc_layout_module`
--
...
--
-- Volcado de datos para la tabla `oc_layout_module`
--
...
--
-- Estructura de tabla para la tabla `oc_layout_route`
--
...
--
-- Volcado de datos para la tabla `oc_layout_route`
--
...
--
-- Estructura de tabla para la tabla `oc_length_class`
--
...
--
-- Volcado de datos para la tabla `oc_length_class`
--
...
--
-- Estructura de tabla para la tabla `oc_length_class_description`
--
...
--
-- Volcado de datos para la tabla `oc_length_class_description`
--
...
--
-- Estructura de tabla para la tabla `oc_location`
--
...
--
-- Estructura de tabla para la tabla `oc_manufacturer`
--
...
--
-- Volcado de datos para la tabla `oc_manufacturer`
--
...
--
-- Estructura de tabla para la tabla `oc_manufacturer_to_layout`
--
...
--
-- Estructura de tabla para la tabla `oc_manufacturer_to_store`
--
...
--
-- Volcado de datos para la tabla `oc_manufacturer_to_store`
--
...
--
-- Estructura de tabla para la tabla `oc_marketing`
--
...
--
-- Estructura de tabla para la tabla `oc_marketing_report`
--
...
--
-- Estructura de tabla para la tabla `oc_module`
--
...
--
-- Volcado de datos para la tabla `oc_module`
--
...
--
-- Estructura de tabla para la tabla `oc_notification`
--
...
--
-- Estructura de tabla para la tabla `oc_option`
--
...
--
-- Volcado de datos para la tabla `oc_option`
--
...
--
-- Estructura de tabla para la tabla `oc_option_description`
--
...
--
-- Volcado de datos para la tabla `oc_option_description`
--
...
--
-- Estructura de tabla para la tabla `oc_option_value`
--
...
--
-- Volcado de datos para la tabla `oc_option_value`
--
...
--
-- Estructura de tabla para la tabla `oc_option_value_description`
--
...
--
-- Volcado de datos para la tabla `oc_option_value_description`
--
...
--
-- Estructura de tabla para la tabla `oc_order`
--
...
--
-- Volcado de datos para la tabla `oc_order`
--
...
(1, 0, 0, 'INV-2024-00', '', 0, 'Your Store', 'http://localhost/upload/', 1, 1, 'Miguel', 'Reyes', 'mr8942734@gmail.com', '', '\"\"', 0, '', '', '', '', '', '', '', '', 0, '', 0, '', '[]', '{\"code\":\"cod.cod\",\"name\":\"Cash On Delivery\"}', 1, 'Miguel', 'Reyes', 'Gamefriend100', 'Agustin Arriaga Rivera #720', '', 'Puruandiro', '58507', 'Mexico', 138, 'Michoacan de Ocampo', 2160, '{firstname} {lastname}\r\n{company}\r\n{address_1}\r\n{address_2}\r\n{city}, {zone} {postcode}\r\n{country}', '\"\"', '{\"code\":\"flat.flat\",\"name\":\"Flat Shipping Rate\",\"cost\":\"5.00\",\"tax_class_id\":\"9\",\"text\":\"$5.00\"}', '', 106.0000, 1, 0, 0.0000, 0, '', 2, '', 2, 'USD', 1.00000000, '::1', '', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36', 'es,es-419;q=0.9,ja;q=0.8,bg;q=0.7,cs;q=0.6,zh-CN;q=0.5,zh;q=0.4,en;q=0.3', '2024-05-09 09:31:22', '2024-05-09 09:31:40');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_order_history`
--
...
--
-- Volcado de datos para la tabla `oc_order_history`
--

INSERT INTO `oc_order_history` (`order_history_id`, `order_id`, `order_status_id`, `notify`, `comment`, `date_added`) VALUES
(1, 1, 1, 0, '', '2024-05-09 09:31:40');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_order_option`
--
...
--
-- Estructura de tabla para la tabla `oc_order_product`
--
...
--
-- Volcado de datos para la tabla `oc_order_product`
--
...
(1, 1, 40, 0, 'Apple iPhone 13 (128 GB) - Rosa - Distribuidor Autorizado', 'product 11', 1, 101.0000, 101.0000, 0.0000, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_order_status`
--
...
--
-- Volcado de datos para la tabla `oc_order_status`
--
...
--
-- Estructura de tabla para la tabla `oc_order_subscription`
--
...
--
-- Estructura de tabla para la tabla `oc_order_total`
--
...
--
-- Volcado de datos para la tabla `oc_order_total`
--
...
--
-- Estructura de tabla para la tabla `oc_order_voucher`
--
...
--
-- Estructura de tabla para la tabla `oc_product`
--
...
--
-- Volcado de datos para la tabla `oc_product`
--
...
(28, 0, 'Product 1', '', '', '', '', '', '', '', '', '', 939, 7, 'catalog/D_NQ_NP_896424-MLA71783367608_092023-O.webp', 5, 1, 100.0000, 200, 9, '2009-02-03', 146.40000000, 2, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 0, 1, '2009-02-03 16:06:50', '2024-05-09 09:13:29'),
(30, 0, 'Product 3', '', '', '', '', '', '', '', '', '', 7, 6, 'catalog/D_NQ_NP_863739-MLM73952092625_012024-O.webp', 9, 1, 100.0000, 0, 9, '2009-02-03', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 0, 1, '2009-02-03 16:59:00', '2024-05-09 09:18:15'),
...
(34, 0, 'Product 7', '', '', '', '', '', '', '', '', '', 1000, 6, 'catalog/D_NQ_NP_709898-MLM70285643842_072023-O.webp', 8, 1, 15000.0000, 0, 9, '2009-02-03', 5.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 2, 1, 1, 0, 0, 1, '2009-02-03 18:07:54', '2024-05-09 11:51:51'),
(35, 0, 'Product 8', '', '', '', '', '', '', '', '', '', 1000, 5, 'catalog/D_NQ_NP_912419-MLU75150999045_032024-O.webp', 0, 0, 100.0000, 0, 9, '2009-02-03', 5.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 0, 1, '2009-02-03 18:08:31', '2024-05-09 11:40:30'),
(36, 0, 'Product 9', '', '', '', '', '', '', '', '', '', 994, 6, 'catalog/D_NQ_NP_908344-MLU73696256573_122023-O.webp', 8, 0, 2000.0000, 100, 9, '2009-02-03', 5.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 2, 1, 1, 0, 0, 1, '2009-02-03 18:09:19', '2024-05-09 11:49:40'),
(40, 0, 'product 11', '', '', '', '', '', '', '', '', '', 969, 5, 'catalog/D_NQ_NP_654080-MLA47781882564_102021-O.webp', 8, 1, 1011.0000, 0, 9, '2009-02-03', 10.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 0, 1, '2009-02-03 21:07:12', '2024-05-09 11:44:26'),
(41, 0, 'Product 14', '', '', '', '', '', '', '', '', '', 977, 5, 'catalog/D_NQ_NP_819841-MLM74521594681_022024-O.webp', 8, 1, 5000.0000, 0, 9, '2009-02-03', 5.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 0, 1, '2009-02-03 21:07:26', '2024-05-09 11:48:19'),
(42, 0, 'Product 15', '', '', '', '', '', '', '', '', '', 990, 5, 'catalog/D_NQ_NP_788922-MLU72567967976_112023-O.webp', 8, 1, 100.0000, 400, 9, '2009-02-04', 12.50000000, 1, 1.00000000, 2.00000000, 3.00000000, 1, 1, 2, 0, 0, 1, '2009-02-03 21:07:37', '2024-05-09 11:33:28'),
(43, 0, 'Product 16', '', '', '', '', '', '', '', '', '', 929, 5, 'catalog/D_NQ_NP_801112-MLA46516512347_062021-O.webp', 8, 0, 500.0000, 0, 9, '2009-02-03', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 2, 1, 1, 0, 0, 1, '2009-02-03 21:07:49', '2024-05-09 11:32:55'),
(44, 0, 'Product 17', '', '', '', '', '', '', '', '', '', 1000, 5, 'catalog/D_NQ_NP_702057-MLM72058983623_102023-O.webp', 8, 1, 10000.0000, 0, 9, '2009-02-03', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 2, 1, 1, 0, 0, 1, '2009-02-03 21:08:00', '2024-05-09 11:36:53'),
(46, 0, 'Product 19', '', '', '', '', '', '', '', '', '', 1000, 5, 'catalog/D_NQ_NP_834763-MLM72829741198_112023-O.webp', 10, 1, 1000.0000, 0, 9, '2009-02-03', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 2, 1, 1, 0, 0, 1, '2009-02-03 21:08:29', '2024-05-09 11:38:22'),
(47, 0, 'Product 21', '', '', '', '', '', '', '', '', '', 1000, 5, 'catalog/D_NQ_NP_717499-MLM72113697935_102023-O.webp', 7, 1, 100.0000, 400, 9, '2009-02-03', 1.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 0, 1, 0, 0, 1, '2009-02-03 21:08:40', '2024-05-09 11:33:14'),
(48, 0, 'product 20', 'test 1', '', '', '', '', '', 'test 2', '', '', 995, 5, 'catalog/D_NQ_NP_925492-MLU74227299784_022024-O.webp', 8, 1, 1500.0000, 0, 9, '2009-02-08', 1.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 2, 1, 1, 0, 0, 1, '2009-02-08 17:21:51', '2024-05-09 11:46:46'),
(50, 0, 'Pc Gamer Yeyian Araki R04 03w Ryzen5 5600g/16gb /120/1tb Hdd', '', '', '', '', '', '', '', '', '', 12, 6, 'catalog/D_NQ_NP_603439-MLU74488295233_022024-O.webp', 0, 1, 100000.0000, 0, 9, '2024-05-09', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 1, 1, '2024-05-09 11:42:51', '2024-05-09 11:43:05'),
(51, 0, 'Proyector 1', '', '', '', '', '', '', '', '', '', 22, 6, 'catalog/D_NQ_NP_662887-MLU75106280377_032024-O.webp', 0, 1, 1500.0000, 0, 9, '2024-05-09', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 1, 1, '2024-05-09 11:55:56', '2024-05-09 12:03:32'),
(52, 0, 'Proyector 1', '', '', '', '', '', '', '', '', '', 1, 6, 'catalog/D_NQ_NP_626337-MLA70581518148_072023-O.webp', 0, 1, 3600.0000, 0, 9, '2024-05-09', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 1, 1, '2024-05-09 11:58:29', '2024-05-09 11:58:29'),
(53, 0, 'Proyector 1', '', '', '', '', '', '', '', '', '', 199, 6, 'catalog/D_NQ_NP_707983-MLA71875543786_092023-O.webp', 0, 1, 99.0000, 0, 9, '2024-05-09', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 1, 1, '2024-05-09 12:02:38', '2024-05-09 12:03:16'),
(54, 0, 'Proyector 1', '', '', '', '', '', '', '', '', '', 199, 6, 'catalog/D_NQ_NP_824487-MLM52548804945_112022-O.webp', 0, 1, 199.0000, 0, 9, '2024-05-09', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 1, 1, '2024-05-09 12:05:13', '2024-05-09 12:05:42'),
(55, 0, 'Proyector 1', '', '', '', '', '', '', '', '', '', 122, 6, 'catalog/D_NQ_NP_617505-MLM54546392705_032023-O.webp', 0, 1, 329.0000, 0, 9, '2024-05-09', 0.00000000, 1, 0.00000000, 0.00000000, 0.00000000, 1, 1, 1, 0, 1, 1, '2024-05-09 12:08:14', '2024-05-09 12:08:14');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_product_attribute`
--
...
--
-- Volcado de datos para la tabla `oc_product_attribute`
--
...
--
-- Estructura de tabla para la tabla `oc_product_description`
--
...
--
-- Volcado de datos para la tabla `oc_product_description`
--

INSERT INTO `oc_product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(28, 2, 'Iphone 11', '&lt;p&gt;iPhone 15 Pro Max. Forjado en titanio y equipado con el revolucionario chip A17 Pro, un Botón de Acción personalizable y el sistema de cámaras más potente en un iPhone.&lt;br /&gt;\r\n&lt;br /&gt;\r\nFORJADO EN TITANIO — El iPhone 15 Pro Max tiene un diseño resistente y ligero, con titanio de calidad aeroespacial y parte posterior de vidrio mate texturizado. Frente de Ceramic Shield, más duro que el vidrio más duro de cualquier smartphone. Y resistencia a las salpicaduras, al agua y al polvo.&lt;br /&gt;\r\n&lt;br /&gt;\r\nPANTALLA AVANZADA — La pantalla Super Retina XDR de 6.7 pulgadas con ProMotion aumenta la frecuencia de actualización hasta 120 Hz cuando necesitas el máximo rendimiento gráfico. La Dynamic Island muestra alertas y Actividades en Vivo al instante. Y la pantalla siempre activa te permite tener información siempre a la vista sin mover un dedo.&lt;br /&gt;\r\n&lt;br /&gt;\r\nREVOLUCIONARIO CHIP A17 PRO — Con el GPU de nivel pro, los juegos móviles son más inmersivos, con escenarios llenos de detalles y personajes más realistas. Y el chip A17 Pro es tan eficiente que la batería es capaz de seguirte el ritmo todo el día.&lt;/p&gt;', '', 'HTC Touch HD', '', ''),
(30, 2, 'Pc Gamer Ryzen 5600g 32gb Ram 1tb Ssd Graficos Radeon 7 Wifi', '&lt;p&gt;HTMICROMX&lt;br /&gt;\r\n- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -&lt;br /&gt;\r\nPc Gamer Ryzen 5600g 32gb Ram 1tb Ssd Graficos Radeon 7 Wifi&lt;br /&gt;\r\n&lt;br /&gt;\r\n&lt;br /&gt;\r\nSistema Ensamblado y listo para funcionar, nuevo con garantía de un año, se te envían todas las cajas, manuales y drivers incluidos en tus productos.&lt;br /&gt;\r\n&lt;br /&gt;\r\nIncluye Windows 10 Pro de 64 Bits (actualizable a Windows 11) versión de Prueba por 30 días.&lt;br /&gt;\r\n&lt;br /&gt;\r\n&lt;br /&gt;\r\nLISTA DE COMPONENTES:&lt;br /&gt;\r\n&lt;br /&gt;\r\nGabinete A ELEGIR:&lt;br /&gt;\r\n-Acteck Fusion II NEGRO GI440 RGB, Ventana, USB 3.0 &amp;amp; Audio&lt;br /&gt;\r\n-Acteck Fusion II BLANCO GI440 RGB, Ventana, USB 3.0 &amp;amp; Audio&lt;br /&gt;\r\n-Acteck Fuji GC470 Doble Ventilador LED Multicolor, Ventana, USB 3.0 &amp;amp; Audio&lt;br /&gt;\r\n-Acteck Kioto GC460 RGB Ventana, USB 3.0 &amp;amp; Audio&lt;br /&gt;\r\n-Acteck Viken NEGRO GM434 RGB,Ventana, USB2.0 Negro &amp;amp; Audio&lt;br /&gt;\r\n-Acteck Viken BLANCO GM434 RGB,Ventana, USB2.0 Negro &amp;amp; Audio&lt;br /&gt;\r\n&lt;br /&gt;\r\nFuente de poder:&lt;br /&gt;\r\nActeck de 500W Incluida en el Gabinete&lt;br /&gt;\r\nProcesador:&lt;br /&gt;\r\nAMD Ryzen 5 5600G Hasta 4.4Ghz 12 Hilos Gráficos Radeon 7&lt;br /&gt;\r\nDisipador:&lt;br /&gt;\r\nWraith Stealth De Fabrica Incluido en el Procesador&lt;br /&gt;\r\nPlaca Madre:&lt;br /&gt;\r\nGigabyte A520M K V2 Lista para AMD Ryzen 5000 Socket AM4&lt;br /&gt;\r\n2 Ranuras para Memoria (Soporta hasta 64GB de RAM)&lt;br /&gt;\r\nMemoria RAM:&lt;br /&gt;\r\nKit Corsair Vengeance LPX 32GB 2x16GB DDR4 3200Mhz&lt;br /&gt;\r\nUnidad SSD:&lt;br /&gt;\r\nKingston SSD NV2 1TB M.2 Pcie 4.0 NVME 2280 3500Mbps&lt;br /&gt;\r\nTarjeta de Video:&lt;br /&gt;\r\nGráficos Radeon 7 Integrados en el Procesador&lt;br /&gt;\r\nSoporta Doble Monitor, 1 x HDMI y 1 x VGA&lt;br /&gt;\r\nRed WiFi GRATIS:&lt;br /&gt;\r\nAdaptador WiFi de 600MBPS + Bluetooth v4.2 Mini USB con Antena&lt;br /&gt;\r\n&lt;br /&gt;\r\nPeriféricos: No Incluye Teclado, Mouse, ni Bocinas&lt;br /&gt;\r\nMonitor: No Incluye Ningún Monitor&lt;br /&gt;\r\n&lt;br /&gt;\r\nEnvió: Gratis a Todo México&lt;br /&gt;\r\n&lt;br /&gt;\r\n- - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -&lt;br /&gt;\r\nTODOS LOS PRECIOS INCLUYEN IVA PARA TU FACTURA&lt;br /&gt;\r\n&lt;br /&gt;\r\nGarantía del vendedor: 12 meses&lt;/p&gt;', '', 'sdf', '', ''),
...
(34, 2, 'Samsung Galaxy S21 128 Gb Gris Reacondicionado Grado A (Reacondicionado)', '&lt;p&gt;El Samsung Galaxy S21 es un dispositivo de alta calidad que ofrece un rendimiento impresionante y un diseño elegante. Con nuestro dispositivo reacondicionado, puedes experimentar todas las características y ventajas del Samsung Galaxy S21 Plus al mejor precio del mercado.&lt;br /&gt;\r\n&lt;br /&gt;\r\nEste dispositivo cuenta con una batería con una capacidad del 80-90% lo que significa que tendrás suficiente energía para mantenerte conectado y productivo durante todo el día. Además, su estética es impecable, lo que significa que tendrás un dispositivo que no solo funciona de manera excelente, sino que también se ve impresionante.&lt;br /&gt;\r\n&lt;br /&gt;\r\nEste dispositivo también está liberado para usarlo con cualquier compañía telefónica, por lo que podrás elegir el plan que mejor se adapte a tus necesidades. Todos los componentes son 100% originales, por lo que puedes estar seguro de que estás recibiendo un producto de alta calidad. Ofrecemos envíos gratis a todo el país y podemos emitir facturas fiscales 100% deducibles.&lt;br /&gt;\r\n&lt;br /&gt;\r\nNo te pierdas esta oportunidad única de obtener un Samsung Galaxy S21 reacondicionado con una batería y estética excepcionales a un precio inigualable. ¡Ordena hoy mismo y experimenta la calidad y el rendimiento de un Samsung Galaxy S21 por ti mismo!.&lt;br /&gt;\r\n&lt;br /&gt;\r\nGarantía del vendedor: 90 días&lt;/p&gt;', '', 'iPod Shuffle', '', ''),
(35, 2, 'Xtreme PC Gaming MSI AMD Radeon Vega Renoir Ryzen 7 5700G 16GB SSD 500GB 3TB WIFI', '&lt;p&gt;Gráficos AMD Radeon con frecuencia de 2000 MHz y 8 núcleos para un rendimiento rápido y fluido en juegos.&lt;br /&gt;\r\n&lt;br /&gt;\r\nPROCESADOR&lt;br /&gt;\r\nAMD Ryzen 7 5700G, 8 núcleos y 16 hilos, 3.8 GHz de velocidad base y 4.6 GHz de velocidad máxima, 16MB L3 en Cache.&lt;br /&gt;\r\n&lt;br /&gt;\r\nMEMORIA RAM&lt;br /&gt;\r\n16GB DDR4 con frecuencia de 3200MHz.&lt;br /&gt;\r\n&lt;br /&gt;\r\nUNIDAD DE ESTADO SOLIDO&lt;br /&gt;\r\nSSD 500GB.&lt;br /&gt;\r\n&lt;br /&gt;\r\nDISCO DURO MECANICO&lt;br /&gt;\r\nHDD 3TB para almacenamiento de juegos, música, archivos y fotos.&lt;br /&gt;\r\n&lt;br /&gt;\r\nFUENTE DE PODER&lt;br /&gt;\r\n600W que cumple con estrictos estándares de calidad.&lt;br /&gt;\r\n&lt;br /&gt;\r\nTarjeta Madre&lt;br /&gt;\r\nChipset AMD B450.&lt;br /&gt;\r\n&lt;br /&gt;\r\nSISTEMA OPERATIVO&lt;br /&gt;\r\nWindows 10 Versión para evaluación de componentes.&lt;/p&gt;', '', 'Product 8', '', ''),
(36, 2, 'Smartphone Honor 90 Lite 8+256gb Dual Sim Color Plateado', '&lt;h2&gt;Lo que tienes que saber de este producto&lt;/h2&gt;\r\n\r\n&lt;ul&gt;\r\n	&lt;li&gt;Memoria RAM: 8 GB&lt;/li&gt;\r\n	&lt;li&gt;Dispositivo desbloqueado para que elijas la compañía telefónica que prefieras.&lt;/li&gt;\r\n	&lt;li&gt;Compatible con redes 5G.&lt;/li&gt;\r\n	&lt;li&gt;Pantalla de 6.7&quot;.&lt;/li&gt;\r\n	&lt;li&gt;Tiene 3 cámaras traseras de 100Mpx/5Mpx/2Mpx.&lt;/li&gt;\r\n	&lt;li&gt;Cámara delantera de 16Mpx.&lt;/li&gt;\r\n	&lt;li&gt;Batería de 4500mAh.&lt;/li&gt;\r\n	&lt;li&gt;Memoria interna de 256GB.&lt;/li&gt;\r\n	&lt;li&gt;Con sensor de huella dactilar.&lt;/li&gt;\r\n&lt;/ul&gt;', '', 'iPod Nano', '', ''),
(40, 2, 'Apple iPhone 13 (128 GB) - Rosa - Distribuidor Autorizado', '&lt;p class=&quot;intro&quot;&gt;iPhone 13. El sistema de dos cámaras más avanzado en un iPhone. El superrápido chip A15 Bionic. Un gran&lt;br /&gt;\r\nsalto en duración de batería. Un diseño resistente. Y una pantalla Super Retina XDR más brillante.&lt;br /&gt;\r\n&lt;br /&gt;\r\nAvisos Legales&lt;br /&gt;\r\n1La pantalla tiene esquinas redondeadas que siguen el elegante diseño curvo del teléfono, y las esquinas se encuentran dentro de un rectángulo estándar. Si se mide en forma de rectángulo estándar, la pantalla tiene 6.06 pulgadas en diagonal. El área real de visualización es menor.&lt;br /&gt;\r\n2La duración de la batería varía según el uso y la configuración. Para obtener más información, visita apple.com/mx/batteries.&lt;br /&gt;\r\n3El iPhone 13 es resistente a los derrames, a las salpicaduras y al polvo, y fue probado en condiciones de laboratorio controladas, con una clasificación IP68 según la norma IEC 60529. La resistencia a los derrames, a las salpicaduras y al polvo no es una condición permanente, y podría disminuir como consecuencia del uso normal. No intentes cargar un iPhone mojado; consulta el manual del usuario para ver las instrucciones de limpieza y secado. La garantía no cubre daños producidos por líquidos.&lt;br /&gt;\r\n4Algunas funcionalidades podrían no estar disponibles en todos los países o áreas.&lt;br /&gt;\r\n5Los accesorios se venden por separado.&lt;/p&gt;', '', 'iPhone', '', ''),
(41, 2, 'Honor X8b 8+512 Gb Color Plata', '&lt;div&gt;El HONOR X8b es el más avanzado de este par. Su diseño se caracteriza por un módulo cuadrado para las cámaras en la parte trasera y un acabado plano en los laterales. Su pantalla también es plana, a diferencia de otros modelos de la gama premium y media, como el Honor Magic5 Lite.&lt;br /&gt;\r\n&lt;br /&gt;\r\nEl Honor X8b tiene pantalla AMOLED de 6.7 pulgadas con resolución Full HD+ y tasa de refresco de 90 Hz. El panel tiene agujero para la cámara frontal, pero en forma de cápsula, al estilo del iPhone 15. Esta es la característica única del HONOR X8b, la nueva ‘Cápsula Mágica’. Se trata de una función que, al igual que la Dynamic Island del iPhone 15, muestra información relevante de algunas aplicaciones en la pantalla.&lt;br /&gt;\r\n&lt;br /&gt;\r\nPor dentro, el HONOR X8b tiene chipset Snapdragon 680 de 6 nanómetros, que promete un rendimiento solvente. Además, cuenta con 8 GB de RAM y 256 GB de almacenamiento fijo, que le dan una gran capacidad. Su batería de 4,500 mAh tiene carga rápida de 35W y su sistema es Android 13 con MagicOS 7.2.&lt;br /&gt;\r\n&lt;br /&gt;\r\nEn el apartado fotográfico, el Honor X8b tiene una cámara principal de 108 MP con lentes de apertura f/1.75, ultra gran angular de 5 MP f/2,2 y una cámara para captura de profundidad de 2 MP f/2.4. Su cámara frontal es de 50 MP con lentes f/2.1.&lt;br /&gt;\r\n&lt;br /&gt;\r\nGarantía del vendedor: 3 meses&lt;/div&gt;', '', 'iMac', '', ''),
(42, 2, 'Laptop HP 240 G9 plateada 14&quot;, Intel Celeron N4500 8GB de RAM 256GB SSD, Intel UHD Graphics (Jasper Lake 16 EU) 1366x768px Windows 11 Home', '&lt;h2&gt;Lo que tienes que saber de este producto&lt;/h2&gt;\r\n\r\n&lt;ul&gt;\r\n	&lt;li&gt;Con pantalla táctil: No&lt;/li&gt;\r\n	&lt;li&gt;Resolución de la pantalla: 1366 px x 768 px&lt;/li&gt;\r\n	&lt;li&gt;Procesador: Intel Celeron N4500&lt;/li&gt;\r\n	&lt;li&gt;Sistema operativo: Windows 11 Home&lt;/li&gt;\r\n	&lt;li&gt;Capacidad de disco SSD: 256 GB&lt;/li&gt;\r\n	&lt;li&gt;Procesador Intel Celeron.&lt;/li&gt;\r\n	&lt;li&gt;Memoria RAM de 8GB.&lt;/li&gt;\r\n	&lt;li&gt;Resolución de 1366x768&amp;nbsp;px.&lt;/li&gt;\r\n	&lt;li&gt;Es antirreflejo.&lt;/li&gt;\r\n	&lt;li&gt;Tarjeta gráfica Intel UHD Graphics (Jasper Lake 16 EU).&lt;/li&gt;\r\n	&lt;li&gt;Conexión wifi y bluetooth.&lt;/li&gt;\r\n	&lt;li&gt;Cuenta con 3 puertos USB y puerto HDMI.&lt;/li&gt;\r\n	&lt;li&gt;Modo de sonido Stereo.&lt;/li&gt;\r\n	&lt;li&gt;La duración de la batería depende del uso que se le dé al producto.&lt;/li&gt;\r\n&lt;/ul&gt;', '', 'Apple Cinema 30', '', ''),
(43, 2, 'Apple Macbook Air (13 pulgadas, 2020, Chip M1, 256 GB de SSD, 8 GB de RAM) - Gris espacial - Distribuidor autorizado', '&lt;div&gt;\r\n&lt;h2&gt;Lo que tienes que saber de este producto&lt;/h2&gt;\r\n\r\n&lt;ul&gt;\r\n	&lt;li&gt;Tarjeta gráfica: Apple M1 8-Core GPU&lt;/li&gt;\r\n	&lt;li&gt;Resolución de la pantalla: 2560 px x 1600 px&lt;/li&gt;\r\n	&lt;li&gt;Procesador: Apple M1&lt;/li&gt;\r\n	&lt;li&gt;Sistema operativo: macOS&lt;/li&gt;\r\n	&lt;li&gt;Capacidad de disco SSD: 256 GB&lt;/li&gt;\r\n	&lt;li&gt;Memoria RAM: 8 GB&lt;/li&gt;\r\n	&lt;li&gt;Chip M1 de Apple que permite un gran avance en el rendimiento del CPU, GPU y aprendizaje automático.&lt;/li&gt;\r\n	&lt;li&gt;Hasta 18 horas de batería para hacer mucho más (1).&lt;/li&gt;\r\n	&lt;li&gt;CPU de 8 núcleos con un rendimiento hasta 3.5 veces más rápido para que puedas hacer de todo a una velocidad insuperable (2).&lt;/li&gt;\r\n	&lt;li&gt;GPU de hasta 8 núcleos con gráficos hasta 5 veces más veloces para apps y juegos con gráficos avanzados (2).&lt;/li&gt;\r\n	&lt;li&gt;Neural Engine de 16 núcleos para un aprendizaje automático avanzado.&lt;/li&gt;\r\n	&lt;li&gt;8 GB de memoria unificada para que todo sea más rápido y fluido.&lt;/li&gt;\r\n	&lt;li&gt;Almacenamiento SSD superrápido para abrir apps y archivos al instante.&lt;/li&gt;\r\n	&lt;li&gt;Diseño silencioso, sin ventilador.&lt;/li&gt;\r\n	&lt;li&gt;Pantalla Retina de 13.3 pulgadas con una amplia gama de colores P3 para que disfrutes imágenes vibrantes y un nivel de detalle increíble (3).&lt;/li&gt;\r\n	&lt;li&gt;Cámara FaceTime HD con procesador de señal de imagen avanzado para hacer llamadas de video claras y nítidas.&lt;/li&gt;\r\n	&lt;li&gt;Sistema de tres micrófonos que se enfocan en tu voz y no en el ruido ambiental.&lt;/li&gt;\r\n	&lt;li&gt;Wi-Fi 6 de última generación para una conectividad más rápida.&lt;/li&gt;\r\n	&lt;li&gt;Dos puertos Thunderbolt/USB 4 para cargar y conectar accesorios.&lt;/li&gt;\r\n	&lt;li&gt;Magic Keyboard retroiluminado y Touch ID para desbloquear tu MacBook Air de forma segura.&lt;/li&gt;\r\n	&lt;li&gt;macOS con un diseño impactante e intuitivo, que funciona a la perfección con tu iPhone.&lt;/li&gt;\r\n	&lt;li&gt;Disponible en color oro, color plata y gris espacial.&lt;/li&gt;\r\n&lt;/ul&gt;\r\n&lt;/div&gt;', '', 'MacBook', '', ''),
(44, 2, 'Xtreme Pc Amd Radeon Renoir Ryzen 5 5600g 16gb Ssd 2tb Wifi', '&lt;div&gt;Gráficos AMD Radeon Graphics con frecuencia de 1900 MHz y 7 núcleos lo que proporciona un rendimiento rápido, sin interrupciones y fluido en los juegos que te apasionan, más potente de lo que crees.&lt;br /&gt;\r\n&lt;br /&gt;\r\nPROCESADOR&lt;br /&gt;\r\nAMD Ryzen 5 5600G con 6 núcleos y 12 hilos 3.9 GHz de velocidad y 4.4 velocidad turbo con 16MB L3 en Cache.&lt;br /&gt;\r\n&lt;br /&gt;\r\nMEMORIA RAM 16GB DDR4 frecuencia de 3200MHz se encargarán de darle a tu equipo la potencia y la fuerza para correr tus programas y juegos favoritos&lt;br /&gt;\r\n&lt;br /&gt;\r\nUNIDAD DE ESTADO SOLIDO SSD 120GB&lt;br /&gt;\r\nDISCO DURO MECANICO HDD 2TB&lt;br /&gt;\r\nGuarda todos tus juegos, música, archivos, fotos y programas&lt;br /&gt;\r\n&lt;br /&gt;\r\nFUENTE DE PODER 600W cumple además con estrictos estándares de calidad para asegurar un uso prolongado en tu sistema de cómputo.&lt;br /&gt;\r\n&lt;br /&gt;\r\nTarjeta Madre CHIPSET AMD B450&lt;br /&gt;\r\n&lt;br /&gt;\r\nADAPTADOR WIFI&lt;br /&gt;\r\nNo te preocupes de los cables, adaptador Wi-Fi incluido hasta 150Mbps&lt;br /&gt;\r\n&lt;br /&gt;\r\nSISTEMA OPERATIVO: Windows 10 Versión para evaluación de componentes. No aplica garantía por software.&lt;br /&gt;\r\n&lt;br /&gt;\r\nGarantía del proveedor 12 Meses: No se hará valida la garantía si cuenta con daño físico y/o descargas eléctricas y se necesita empaque original de los componentes.&lt;/div&gt;', '', 'MacBook Air', '', ''),
(46, 2, 'Xtreme Pc Amd Radeon Vega Renoir Ryzen 5 4650g 8gb 1tb Wifi', '&lt;div&gt;Gráficos AMD Radeon 7 Renoir con frecuencia de 1900MHz y 7 núcleos lo que proporciona un rendimiento rápido, sin interrupciones y fluido en los juegos que te apasionan, más potente de lo que crees.&lt;br /&gt;\r\n&lt;br /&gt;\r\nPROCESADOR&lt;br /&gt;\r\nAMD Ryzen 5 4600G con 6 núcleos y 12 hilos 3.7 GHz de velocidad y 4.2 velocidad turbo con 8MB L3 en Cache.&lt;br /&gt;\r\n&lt;br /&gt;\r\nMEMORIA RAM 8GB DDR4 frecuencia de 2666MHz se encargarán de darle a tu equipo la potencia y la fuerza para correr tus programas y juegos favoritos&lt;br /&gt;\r\n&lt;br /&gt;\r\nDISCO DURO MECANICO HDD 1TB.&lt;br /&gt;\r\nGuarda todos tus juegos, música, archivos, fotos y programas.&lt;br /&gt;\r\n&lt;br /&gt;\r\nFUENTE DE PODER 500W cumple además con estrictos estándares de calidad para asegurar un uso prolongado en tu sistema de cómputo.&lt;br /&gt;\r\n&lt;br /&gt;\r\nTarjeta Madre CHIPSET AMD A320&lt;br /&gt;\r\n&lt;br /&gt;\r\nADAPTADOR WIFI&lt;br /&gt;\r\nNo te preocupes de los cables, adaptador Wi-Fi incluido hasta 150Mbps&lt;br /&gt;\r\n&lt;br /&gt;\r\nSISTEMA OPERATIVO: Windows 10 Versión para evaluación de componentes. No aplica garantía por software.&lt;br /&gt;\r\n&lt;br /&gt;\r\nGarantía del proveedor 12 Meses: No se hará valida la garantía si cuenta con daño físico y/o descargas eléctricas y se necesita empaque original de los componentes.&lt;br /&gt;\r\n&lt;br /&gt;\r\nGarantía del vendedor: 12 mesest and greater energy efficiency, all the high-performance essentials are seamlessly combined into a single chip.&lt;/div&gt;', '', 'Sony VAIO', '', ''),
...
(48, 2, 'Apple iPhone 13 Pro (256 GB) - Azul sierra', '&lt;h2&gt;Lo que tienes que saber de este producto&lt;/h2&gt;\r\n\r\n&lt;ul&gt;\r\n	&lt;li&gt;Memoria RAM: 6 GB&lt;/li&gt;\r\n	&lt;li&gt;Pantalla Super Retina XDR de 6.1 pulgadas con ProMotion que brinda una respuesta más rápida y fluida.(1)&lt;/li&gt;\r\n	&lt;li&gt;Modo Cine con baja profundidad de campo y cambios de enfoque automáticos en tus videos.&lt;/li&gt;\r\n	&lt;li&gt;Nuevo sistema de cámaras Pro de 12 MP (teleobjetivo, gran angular y ultra gran angular), escáner LiDAR, rango de zoom óptico de 6x, fotografía macro, Estilos Fotográficos, video ProRes2, HDR Inteligente 4, modo Noche, Apple ProRAW y grabación de video 4K HDR en Dolby Vision.&lt;/li&gt;\r\n	&lt;li&gt;Cámara frontal TrueDepth de 12 MP con modo Noche y grabación de video 4K HDR en Dolby Vision.&lt;/li&gt;\r\n	&lt;li&gt;Chip A15 Bionic para un rendimiento fuera de serie.&lt;/li&gt;\r\n	&lt;li&gt;Hasta 22 horas de reproducción de video.(3)&lt;/li&gt;\r\n	&lt;li&gt;Diseño resistente con Ceramic Shield.&lt;/li&gt;\r\n	&lt;li&gt;Resistencia al agua IP68, líder en la industria.(4)&lt;/li&gt;\r\n	&lt;li&gt;iOS 15 con nuevas funcionalidades para aprovechar tu iPhone al máximo.(5)&lt;/li&gt;\r\n	&lt;li&gt;Compatibilidad con accesorios MagSafe, que se acoplan fácilmente a tu iPhone y permiten una carga inalámbrica más rápida.(6)&lt;/li&gt;\r\n&lt;/ul&gt;', '', 'Electronicos', '', ''),
(50, 2, 'Pc Gamer Yeyian Araki R04 03w Ryzen5 5600g/16gb /120/1tb Hdd', '&lt;p&gt;PC Gamer Yeyian ARAKI R04 04B RYZEN5 5600G/16GB DDR4/120GBSSD/1TB HDD&lt;br /&gt;\r\n&lt;br /&gt;\r\nLa PC Yeyian ARAKI A04-03W de la colección PC Ronin de Yeyian está diseñada para sobresalir en funcionalidad, modularidad y rendimiento térmico. Construido con componentes estándar, este sistema está equipado con RYZEN 5 - 5600G y tarjeta madre AMD-A320.&lt;br /&gt;\r\n&lt;br /&gt;\r\nLa computadora ARAKI A04-03W ofrece una dimensión completamente nueva al mundo de los Samurais y proporciona una experiencia única para cualquier necesidad.&lt;br /&gt;\r\n&lt;br /&gt;\r\nOptimizado con 16GB de memoria RAM DDR4 3200 MHz, fuente de alimentación de 500 Watt y 120 GB SSD + 1TB HDD, la computadora ARAKI A04-03W ofrece alto rendimiento para todos.&lt;br /&gt;\r\n&lt;br /&gt;\r\nOfrece transmisión de datos rápidos para una experiencia sin LAG en cualquier uso digital.&lt;br /&gt;\r\n&lt;br /&gt;\r\nCon instalación previa del sistema operativo Windows® 11 Home Trial para una operación y rendimiento óptimos.&lt;br /&gt;\r\n&lt;br /&gt;\r\nLa PC para juegos ARAKI A04-03W incluye 3 ventiladores de serie para producir flujo de aire y mantener un enfriamiento óptimo al sistema.&lt;br /&gt;\r\n&lt;br /&gt;\r\nTodas las imágenes son de carácter ilustrativo. El precio y las especificaciones de los productos pueden variar sin previo aviso.&lt;/p&gt;', '', 'Electronicos', '', ''),
(51, 2, 'OnePlus 12 Dual SIM 512 GB verde 16 GB RAM', '&lt;h2&gt;Lo que tienes que saber de este producto&lt;/h2&gt;\r\n\r\n&lt;ul&gt;\r\n	&lt;li&gt;Memoria RAM: 16 GB&lt;/li&gt;\r\n	&lt;li&gt;Dispositivo desbloqueado para que elijas la compañía telefónica que prefieras.&lt;/li&gt;\r\n	&lt;li&gt;Compatible con redes 5G.&lt;/li&gt;\r\n	&lt;li&gt;Pantalla AMOLED de 6.82&quot;.&lt;/li&gt;\r\n	&lt;li&gt;Cámara trasera de 50Mpx.&lt;/li&gt;\r\n	&lt;li&gt;Cámara delantera de 32Mpx.&lt;/li&gt;\r\n	&lt;li&gt;Batería de 5400mAh con carga inalámbrica.&lt;/li&gt;\r\n	&lt;li&gt;Memoria interna de 512GB.&lt;/li&gt;\r\n	&lt;li&gt;Con reconocimiento facial y sensor de huella dactilar.&lt;/li&gt;\r\n&lt;/ul&gt;', '', 'Electronicos', '', ''),
(52, 2, 'OnePlus Nord 3 5G Dual SIM 256 GB tempest gray 16 GB RAM', '&lt;h2&gt;Lo que tienes que saber de este producto&lt;/h2&gt;\r\n\r\n&lt;ul&gt;\r\n	&lt;li&gt;Memoria RAM: 16 GB&lt;/li&gt;\r\n	&lt;li&gt;Dispositivo desbloqueado para que elijas la compañía telefónica que prefieras.&lt;/li&gt;\r\n	&lt;li&gt;Compatible con redes 5G.&lt;/li&gt;\r\n	&lt;li&gt;Pantalla AMOLED de 6.74&quot;.&lt;/li&gt;\r\n	&lt;li&gt;Tiene 3 cámaras traseras de 50Mpx/8Mpx/2Mpx.&lt;/li&gt;\r\n	&lt;li&gt;Cámara delantera de 16Mpx.&lt;/li&gt;\r\n	&lt;li&gt;Procesador MediaTek MT6983 Dimensity 9000 Octa-Core de 3.05GHz con 16GB de RAM.&lt;/li&gt;\r\n	&lt;li&gt;Batería de 5000mAh.&lt;/li&gt;\r\n	&lt;li&gt;Memoria interna de 256GB.&lt;/li&gt;\r\n	&lt;li&gt;Resistente a las salpicaduras.&lt;/li&gt;\r\n	&lt;li&gt;Con reconocimiento facial y sensor de huella dactilar.&lt;/li&gt;\r\n	&lt;li&gt;Resistente al polvo.&lt;/li&gt;\r\n&lt;/ul&gt;', '', 'Electronicos', '', ''),
(53, 2, 'Audífonos Inalámbricos Bluetooth Función Carga Inalámbrica BT3-0066 Negro AVEDISTANTE', '&lt;h2&gt;Lo que tienes que saber de este producto&lt;/h2&gt;\r\n\r\n&lt;ul&gt;\r\n	&lt;li&gt;Es monoaural.&lt;/li&gt;\r\n	&lt;li&gt;Alcance inalámbrico de 8&amp;nbsp;m.&lt;/li&gt;\r\n	&lt;li&gt;Modo manos libres incluido.&lt;/li&gt;\r\n	&lt;li&gt;Con cancelación de ruido.&lt;/li&gt;\r\n	&lt;li&gt;Con estuche de carga inalámbrica.&lt;/li&gt;\r\n	&lt;li&gt;Con micrófono incorporado.&lt;/li&gt;\r\n	&lt;li&gt;Resistente al agua.&lt;/li&gt;\r\n	&lt;li&gt;Su clasificación IP es IPX4.&lt;/li&gt;\r\n	&lt;li&gt;Uso apto para deporte.&lt;/li&gt;\r\n	&lt;li&gt;Sonido superior y sin límites.&lt;/li&gt;\r\n	&lt;li&gt;Cómodo y práctico.&lt;/li&gt;\r\n&lt;/ul&gt;', '', 'Electronicos', '', ''),
(54, 2, 'Audífonos Inalámbricos Bluetooth In-ear Gamer Color Blanco', '&lt;p&gt;Hola amigo, bienvenidos a nuestra tienda, ¡les deseo una vida feliz!&lt;br /&gt;\r\n&lt;br /&gt;\r\nEste producto participa actualmente en el Promoción de Oferta relámpago y Oferta del día. Los descuentos son estupendos. Buena relación calidad-precio. Bueno para uso propio y para regalo.&lt;br /&gt;\r\n&lt;br /&gt;\r\nActualmente, los gastos de envío son gratuitos con la compra de 2 o más unidades de este producto. Si eres miembro de meli+, los gastos de envío son gratuitos por la compra de 1 unidad de este producto. Envío gratuito en compras de 299 pesos o más en nuestra tienda.&lt;br /&gt;\r\n&lt;br /&gt;\r\nAudífonos In-ear Bluetooth Inalámbricos Oem R60S Compatible Con iPhone Xiaomi Android Cre&lt;br /&gt;\r\n&lt;br /&gt;\r\nEste auriculares inalámbricos Bluetooth ofrecen una experiencia de audio de alta calidad con una respuesta de bajos clara y suave que le permitirá disfrutar de todos los estilos de música.&lt;br /&gt;\r\nBluetooth Modelo Sí (R60S),El nombre de Bluetooth es (Pro6s) ,Operación simple y señal estable&lt;br /&gt;\r\n&lt;br /&gt;\r\nLa versión Bluetooth de los auriculares está actualizada a Bluetooth 5.3, que proporciona una mayor distancia de transmisión, una señal más potente y una conexión más estable.&lt;br /&gt;\r\n&lt;br /&gt;\r\nEl estuche de carga de los auriculares incorpora una placa protectora de carga para una carga más estable y segura. Además, la batería del estuche de carga se puede almacenar durante más tiempo.&lt;br /&gt;\r\n&lt;br /&gt;\r\nLos auriculares han ajustado el ecualizador para canciones en español, lo que los hace más adecuados para escuchar canciones en español.&lt;br /&gt;\r\n&lt;br /&gt;\r\nAl abrir la tapa del estuche de carga, los auriculares izquierdo y derecho se encienden automáticamente y se conectan entre sí sin tener que quitarse el auricular. Esto permite conectar más rápidamente los auriculares al teléfono móvil.&lt;br /&gt;\r\n&lt;br /&gt;\r\nCaracterísticas del producto:&lt;br /&gt;\r\n&lt;br /&gt;\r\n1.Calidad de sonido estéreo de alta fidelidad:Los auriculares inalámbricos Bluetooth con tecnología avanzada Bluetooth 5.3 ofrecen una conexión inalámbrica eficaz. Proporcionan una conexión rápida y estable con teléfonos móviles y ordenadores con Bluetooth, sin retrasos, sincronización de audio, mejor calidad de sonido y una distancia de conexión de hasta 10 metros, lo que permite disfrutar de música rápida y de alta calidad en cualquier momento y lugar;&lt;br /&gt;\r\n&lt;br /&gt;\r\n2.Diseño ergonómico:La forma de los mini auriculares Bluetooth está cuidadosamente calculada, muy liviana, ergonómicamente diseñada para adaptarse perfectamente al oído, ya sea que esté haciendo ejercicio, corriendo, entrenando en el gimnasio, ciclismo, senderismo, yoga, fitness, los auriculares permanecerán firmemente en sus oídos;&lt;br /&gt;\r\n&lt;br /&gt;\r\n3.emparejamiento automático:La conexión se realiza en un solo paso, y la operación es conveniente y simple. Cuando saque los auriculares del estuche de carga magnética, los auriculares inalámbricos se conectarán automáticamente al último dispositivo conectado de acuerdo con un programa en la memoria. La primera conexión requiere una conexión manual;&lt;br /&gt;\r\n&lt;br /&gt;\r\n4.toque inteligente:Hay diseños táctiles inteligentes en ambos lados de los auriculares. Toque el oído izquierdo y derecho para contestar o colgar a voluntad; toque dos veces el oído derecho/izquierdo para cambiar la canción anterior/siguiente; toque el oído derecho/izquierdo tres veces para aumentar/disminuir el volumen; esto es muy útil cuando se conduce ;&lt;br /&gt;\r\n&lt;br /&gt;\r\n5.duración de la batería:La capacidad de la batería de los auriculares es de 30mah, y la capacidad de la batería del compartimento de carga es de 200mah, que es un bajo consumo de energía. El estuche de carga portátil puede proporcionar una carga rápida. Reproduce hasta 5 horas de música con una sola carga. El estuche de carga puede cargar los auriculares de 3 a 4 veces (dependiendo de cuánto tiempo use los auriculares) ;&lt;br /&gt;\r\n&lt;br /&gt;\r\n6.Auricular Compatibilidad: Amplia compatibilidad, este auricular bluetooth es compatible con IOS/Android y es compatible con cualquier teléfono móvil o computadora que se pueda conectar a través de bluetooth.&lt;br /&gt;\r\n&lt;br /&gt;\r\nLos pasos para conectar los auriculares bluetooth al teléfono móvil:&lt;br /&gt;\r\n1.Active la función Bluetooth del teléfono móvil;&lt;br /&gt;\r\n2.Conéctese a los auriculares Bluetooth Pro6s emparejados, abra la caja de los auriculares y acérquese al teléfono desbloqueado para conectarse automáticamente;&lt;br /&gt;\r\n3.Saque el auricular del compartimiento de carga e insertelo en su oído y ajustelo hasta que escuche un pitido.&lt;br /&gt;\r\n#Si seguiste los pasos anteriores, felicitaciones por tu conexión y ahora puedes escuchar canciones y hacer llamadas.&lt;br /&gt;\r\n&lt;br /&gt;\r\nUso del producto:&lt;br /&gt;\r\n(1) Estado de indicación LED&lt;br /&gt;\r\nEstado de carga: luz naranja intermitente&lt;br /&gt;\r\nCarga completada: la luz naranja siempre está encendida&lt;br /&gt;\r\nEstado de bajo consumo: el auricular tiene un tono&lt;br /&gt;\r\n(2) Operación de función clave&lt;br /&gt;\r\nEncendido: abra el compartimento de carga para encenderlo automáticamente o manténgalo presionado durante 2 segundos para encenderlo&lt;br /&gt;\r\nApagado: cierre el compartimiento de carga y apague automáticamente&lt;br /&gt;\r\nModo de emparejamiento: emparejamiento automático cuando se enciende&lt;br /&gt;\r\nResponder/colgar: haga clic en los auriculares izquierdo y derecho a voluntad&lt;br /&gt;\r\nReproducir/Pausar: haga clic en el auricular&lt;br /&gt;\r\nCanción anterior/siguiente: Doble toque en el auricular derecho/Siguiente canción, Doble toque izquierdo/Canción anterior&lt;br /&gt;\r\nSubir / bajar volumen: toque el auricular derecho tres veces/sube el volumen, tres veces a la izquierda/bajar volumen&lt;br /&gt;\r\nFunción de voz: mantenga presionado durante 2 segundos para llamar al asistente de voz&lt;br /&gt;\r\n&lt;br /&gt;\r\nLista de embalaje&lt;br /&gt;\r\n1 Caja de embalaje&lt;br /&gt;\r\n1 Auricular inalámbrico Bluetooth L+R&lt;br /&gt;\r\n1 Estuche de carga para auriculares&lt;br /&gt;\r\n1 Cable de carga&lt;br /&gt;\r\n1 Manual del producto&lt;br /&gt;\r\n&lt;br /&gt;\r\nServicio de atención al cliente:Si tiene algún problema, no dude en ponerse en contacto con nosotros y le proporcionaremos el mejor servicio pre y postventa.&lt;br /&gt;\r\n# Si tiene alguna pregunta sobre la calidad después de recibir el producto, no haga un reclamo, comuníquese primero con nuestro servicio de atención al cliente en la página de detalles de su compra y resolveremos el problema por usted.Si envía un reclamo, el procesamiento de acuerdo con las reglas de la plataforma llevará más tiempo.&lt;br /&gt;\r\n&lt;br /&gt;\r\nEn accesorios para celulares, es un gran audifonos inalambricos, es audifonos en oreja, muy confortables auriculares inalambricos! Tiene audifonos manos libres, y es profundamente ganada la Tiene audifonos manos libres, y es profundamente amado por nuestros amigos mexicanos. La elección es el valor para el dinero, usted merece confiar y poseerlo.&lt;br /&gt;\r\n&lt;br /&gt;\r\nLos usuarios del mercado libre lo recomiendan encarecidamente:&lt;br /&gt;\r\n¿Buscas unos audífonos que se ajusten a tu estilo de vida y te brinden una experiencia acústica excepcional? Entonces los Audífonos Bluetooth Oem Compatible iPhone Xiaomi Android Cre son la opción perfecta para ti.&lt;br /&gt;\r\nUna característica destacada por los usuarios es su duración de batería, ya que podrás disfrutar sin interrupciones durante largas sesiones musicales o llamadas telefónicas. Además, estos audífonos mantienen una conexión estable y confiable en todo momento, evitando problemas comunes como entrecruzamiento o desconexiones inesperadas.&lt;br /&gt;\r\nOtro aspecto valorado favorablemente es su relación calidad-precio: aunque tienen un costo accesible, ofrecen un sonido aceptable y cumplen con las expectativas para uso casual o básico. Y si hablamos de comodidad, muchos usuarios encuentran satisfactorio el nivel general al usarlos tanto en actividades diarias como deportivas.&lt;br /&gt;\r\n&lt;br /&gt;\r\nAdemás del rendimiento técnico impecable, destaca su estética atractiva tanto del estuche como de los propios auriculares. Su diseño moderno e innovador hará que destaques donde sea que vayas.&lt;br /&gt;\r\nEn resumen, estos audífonos Bluetooth Oem se posicionan entre las mejores opciones disponibles actualmente gracias a sus características sobresalientes y excelente relación calidad-precio ¡No esperes más! Consigue tus nuevos compañeros auditivos hoy mismo.&lt;/p&gt;', '', 'Electronicos', '', ''),
(55, 2, 'Audífonos In-ear Bluetooth Inalámbricos Oem Air Serie 7', '&lt;p&gt;Estimado cliente, ¡Hola! ¡Bienvenido a nuestra tienda! ¡Le deseamos una vida feliz!&lt;br /&gt;\r\n&lt;br /&gt;\r\nDescripción Del Producto&lt;br /&gt;\r\n&lt;br /&gt;\r\nAuriculares Inalámbrico Bluetooth Con Micrófono, Audífonos Manos Libres In-ear, Diseño De Barra Intraauricular Completa, Carga Magnética Para Auriculares, Gamer Con luz led, Puerto de carga USB Tipo-C, Bluetooth 5.3, Modelo AIR7, SBC Audio Experience, Amplia Compatibilidad, Compatible Con iPhone, Xiaomi, Samsung, Huawei, Motorola y Android.&lt;br /&gt;\r\n&lt;br /&gt;\r\nLista de paquetes&lt;br /&gt;\r\n1 caja de colores&lt;br /&gt;\r\n1 bandeja de producto&lt;br /&gt;\r\n1 auricular izquierdo&lt;br /&gt;\r\n1 auricular derecho&lt;br /&gt;\r\n1 estuche de carga para auriculares&lt;br /&gt;\r\n1 cable de carga&lt;br /&gt;\r\n1 par de almohadillas grandes&lt;br /&gt;\r\n1 par de almohadillas pequeñas&lt;br /&gt;\r\n1 manual de instrucciones bilingüe&lt;br /&gt;\r\n1 manual de instrucciones en español&lt;br /&gt;\r\n&lt;br /&gt;\r\nEstos auriculares inalámbricos Bluetooth proporcionan una experiencia de audio de alta calidad con una respuesta de graves clara y suave que permite disfrutar de una gran variedad de estilos de música.&lt;br /&gt;\r\nEl modelo Bluetooth es (AIR7), el nombre Bluetooth es (TWS-AIR), fácil de manejar, señal estable.&lt;br /&gt;\r\n&lt;br /&gt;\r\nEl color de la funda de carga de los auriculares es negro mate.&lt;br /&gt;\r\n&lt;br /&gt;\r\nLos auriculares izquierdo y derecho tienen luces LED. Puedes comprobar las luces LED para conocer el estado de conexión y el estado de carga de los auriculares izquierdo y derecho, y si la batería de los auriculares está baja.&lt;br /&gt;\r\n&lt;br /&gt;\r\nLos auriculares son más ligeros y cómodos de llevar, al tiempo que garantizan un buen sonido del audífono.&lt;br /&gt;\r\n&lt;br /&gt;\r\nLos auriculares cumplen la norma IP54 de resistencia al polvo y al agua y la norma IPX4 de resistencia al agua. Resistente al agua, a las salpicaduras y al sudor. Se puede utilizar en entornos sudorosos como deportes, fitness y running.&lt;br /&gt;\r\n&lt;br /&gt;\r\nNuestros técnicos han ajustado el ecualizador por defecto de los auriculares en función de las características de las canciones en español, haciendo que los auriculares sean más adecuados para escuchar canciones en español.&lt;br /&gt;\r\n&lt;br /&gt;\r\nCaracterísticas del producto&lt;br /&gt;\r\n&lt;br /&gt;\r\n1. Aspecto de moda: diseño ovalado, aspecto hermoso y de moda, exquisito y compacto. Caja de carga de diseño esmerilado, textura agradable a la piel, no es fácil caerse de la mano.&lt;br /&gt;\r\n&lt;br /&gt;\r\n2. Calidad de sonido estéreo de alta fidelidad: Los auriculares inalámbricos Bluetooth utilizan la avanzada tecnología Bluetooth 5.3 para proporcionar una conectividad inalámbrica eficiente. Proporcionan una conexión rápida y estable con teléfonos y ordenadores Bluetooth, latencia ultrabaja, sincronización de audio, mejor calidad de sonido y una distancia de conexión de hasta 10 metros, lo que le permite disfrutar de música rápida y de alta calidad en cualquier momento y en cualquier lugar.&lt;br /&gt;\r\n&lt;br /&gt;\r\n3. Diseño ergonómico: Auriculares Bluetooth con diseño completo de barra en la oreja, la forma está cuidadosamente calculada, muy ligero, diseño ergonómico, se puede llevar perfectamente en la oreja, si usted está haciendo deporte, correr, entrenamiento en el gimnasio, ciclismo, senderismo, yoga, fitness, los auriculares estarán firmemente en sus oídos. Caja de carga tapa de la cara cerrada a un cierto ángulo, automático fuerte cierre magnético de succión, firmemente adsorbido juntos. Los auriculares se guardan firmemente en la caja de carga. Los auriculares se cargan por succión magnética, y los contactos de carga pueden estar completamente en contacto. Este estuche de carga puede cargar mejor los auriculares.&lt;br /&gt;\r\n&lt;br /&gt;\r\n4. 4. Emparejamiento automático: la conexión se realiza en un solo paso. Cuando saques los auriculares del estuche de carga magnético, los auriculares inalámbricos se conectarán automáticamente al último dispositivo conectado según el programa de la memoria. La primera conexión necesita conectarse manualmente.&lt;br /&gt;\r\n&lt;br /&gt;\r\n5. Tacto inteligente: Hay diseños táctiles inteligentes en ambos lados de los auriculares. Toca la oreja izquierda y la oreja derecha para contestar o colgar el teléfono a voluntad; pulsa prolongadamente la oreja izquierda/la oreja derecha durante 2 segundos para cambiar la canción anterior/siguiente; haz doble clic en la oreja izquierda/la oreja derecha para subir/bajar el volumen paso a paso; esto es muy útil cuando conduces.&lt;br /&gt;\r\n&lt;br /&gt;\r\n6. Duración de la batería: el chip de los auriculares utiliza un chip de bajo consumo, bajo consumo de energía, mayor duración de la batería. La capacidad de la batería del auricular es de 30mah, y la capacidad de la batería del estuche de carga es de 200mah. El estuche de carga portátil puede proporcionar una carga rápida. El puerto de carga del estuche de carga adopta el puerto TYPE-C. El estuche de carga del puerto TYPE-C puede obtener una carga más rápida. Una carga puede reproducir 5 horas de música. El estuche de carga puede cargar los auriculares de 3 a 4 veces (dependiendo del tiempo de uso de los auriculares).&lt;br /&gt;\r\n&lt;br /&gt;\r\n7. Compatibilidad con auriculares: Dado que este auricular Bluetooth soporta la experiencia de audio SBC, es súper compatible con IOS/Android y puede ser compatible con cualquier teléfono u ordenador que se pueda conectar a través de Bluetooth.&lt;br /&gt;\r\n&lt;br /&gt;\r\nPasos para conectar los auriculares Bluetooth y el teléfono móvil&lt;br /&gt;\r\n&lt;br /&gt;\r\n1. Enciende la función Bluetooth de tu teléfono.&lt;br /&gt;\r\n2. Abre el estuche de los auriculares, sácalos del compartimento de carga e introdúcelos en tu oreja.&lt;br /&gt;\r\n3. Acerque el teléfono desbloqueado y conéctelo al auricular TWS Bluetooth emparejado, oirá la palabra en inglés &quot;Connecting&quot;.&lt;br /&gt;\r\n&lt;br /&gt;\r\nSi sigue los pasos anteriores, enhorabuena por su exitosa conexión, ahora puede escuchar canciones y realizar llamadas.&lt;br /&gt;\r\n&lt;br /&gt;\r\nUso del producto&lt;br /&gt;\r\n&lt;br /&gt;\r\n(1)Estado de indicación LED&lt;br /&gt;\r\n&lt;br /&gt;\r\nAuricular&lt;br /&gt;\r\nEstado de carga: luz roja siempre encendida&lt;br /&gt;\r\nCarga completada: luz apagada&lt;br /&gt;\r\nEstado de batería baja: auricular con un pitido&lt;br /&gt;\r\n&lt;br /&gt;\r\nCubo de carga&lt;br /&gt;\r\nEstado de carga: luz roja parpadeante&lt;br /&gt;\r\nCarga completada: luz roja siempre encendida&lt;br /&gt;\r\n&lt;br /&gt;\r\nCaja de carga al auricular cargando, la luz azul de la caja de carga está siempre encendida, cuando el auricular está completamente cargado, la luz está apagada.&lt;br /&gt;\r\n&lt;br /&gt;\r\n(2)Funcionamiento de las teclas&lt;br /&gt;\r\nEncendido: abra el compartimento de carga, saque los auriculares, enciéndalos automáticamente o manténgalos pulsados para encenderlos.&lt;br /&gt;\r\nApagado: vuelve a colocar los auriculares en el compartimento de carga, se apagan automáticamente o pulsa prolongadamente para apagarlos.&lt;br /&gt;\r\nModo de emparejamiento: emparejamiento automático al retirar el auricular.&lt;br /&gt;\r\nResponder/colgar: pulsa el auricular izquierdo y derecho a voluntad&lt;br /&gt;\r\nReproducir/pausa: pulsa en el auricular.&lt;br /&gt;\r\nCanción anterior/siguiente: pulsación larga del auricular derecho durante 2 segundos/siguiente canción, pulsación larga del auricular izquierdo durante 2 segundos/canción anterior&lt;br /&gt;\r\nSubir / bajar el volumen: haz doble clic en el auricular izquierdo para subir el volumen paso a paso, haz doble clic en el auricular derecho para bajarlo paso a paso.&lt;br /&gt;\r\nFunción de voz: tres clics en el auricular derecho puede iniciar Siri o asistente de voz para el control de voz del teléfono.&lt;br /&gt;\r\n&lt;br /&gt;\r\nServicio de atención al cliente&lt;br /&gt;\r\n&lt;br /&gt;\r\nSi tiene alguna pregunta, no dude en ponerse en contacto con nosotros, le proporcionaremos el mejor servicio preventa y postventa.&lt;br /&gt;\r\n&lt;br /&gt;\r\nSi usted tiene algún problema de calidad después de recibir el producto, por favor no presente una reclamación, por favor póngase en contacto con nuestro servicio al cliente en su página de detalles de compra en primer lugar, y vamos a resolver el problema para usted rápidamente. Si presenta una reclamación, de acuerdo con las normas y procesos de la plataforma, la tramitación es más engorrosa, lo que le costará mucho tiempo y no obtendrá una tramitación rápida.&lt;/p&gt;', '', 'Electronicos', '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_product_discount`
--
...
--
-- Volcado de datos para la tabla `oc_product_discount`
--
...
--
-- Estructura de tabla para la tabla `oc_product_filter`
--
...
--
-- Estructura de tabla para la tabla `oc_product_image`
--
...
--
-- Volcado de datos para la tabla `oc_product_image`
--
...
(2371, 30, 'catalog/D_NQ_NP_979616-MLM75055152721_032024-O.webp', 0),
(2373, 43, 'catalog/D_NQ_NP_645799-MLA46516517280_062021-O.webp', 0),
(2374, 47, 'catalog/demo/hp_2.jpg', 0),
(2375, 47, 'catalog/demo/hp_3.jpg', 0),
(2376, 42, 'catalog/D_NQ_NP_928095-MLU75175877870_032024-O.webp', 0),
(2379, 44, 'catalog/D_NQ_NP_627494-MLM72059041515_102023-O.webp', 0),
(2380, 46, 'catalog/D_NQ_NP_795560-MLM72885201205_112023-O.webp', 0),
(2381, 35, 'catalog/D_NQ_NP_905012-MLU75009965666_032024-O.webp', 0),
(2383, 50, 'catalog/D_NQ_NP_829458-MLU74368897062_022024-O.webp', 0),
(2384, 48, 'catalog/D_NQ_NP_891710-MLU74227299788_022024-O.webp', 0),
(2385, 48, 'catalog/D_NQ_NP_738309-MLU74339504497_022024-O.webp', 0),
(2386, 41, 'catalog/D_NQ_NP_761389-MLM74401454996_022024-O.webp', 0),
(2387, 36, 'catalog/D_NQ_NP_904510-MLU74192183281_012024-O.webp', 0),
(2388, 34, 'catalog/D_NQ_NP_772597-MLM70285643844_072023-O.webp', 0),
(2391, 52, 'catalog/D_NQ_NP_926542-MLU73794904972_012024-O.webp', 0),
(2393, 53, 'catalog/D_NQ_NP_725637-MLA71145152687_082023-O.webp', 0),
(2394, 51, 'catalog/D_NQ_NP_690331-MLU75106555217_032024-O.webp', 0),
(2396, 54, 'catalog/D_NQ_NP_954418-MLM52548842694_112022-O.webp', 0),
(2397, 55, 'catalog/D_NQ_NP_787667-MLM54548931792_032023-O.webp', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_product_option`
--
...
--
-- Volcado de datos para la tabla `oc_product_option`
--
...
--
-- Estructura de tabla para la tabla `oc_product_option_value`
--
...
--
-- Volcado de datos para la tabla `oc_product_option_value`
--
...
--
-- Estructura de tabla para la tabla `oc_product_related`
--
...
--
-- Volcado de datos para la tabla `oc_product_related`
--
...
--
-- Estructura de tabla para la tabla `oc_product_report`
--
...
--
-- Estructura de tabla para la tabla `oc_product_reward`
--
...
--
-- Volcado de datos para la tabla `oc_product_reward`
--
...
--
-- Estructura de tabla para la tabla `oc_product_special`
--
...
--
-- Volcado de datos para la tabla `oc_product_special`
--
...
--
-- Estructura de tabla para la tabla `oc_product_subscription`
--
...
--
-- Estructura de tabla para la tabla `oc_product_to_category`
--
...
--
-- Volcado de datos para la tabla `oc_product_to_category`
--
...
--
-- Estructura de tabla para la tabla `oc_product_to_download`
--
...
--
-- Estructura de tabla para la tabla `oc_product_to_layout`
--
...
--
-- Volcado de datos para la tabla `oc_product_to_layout`
--
...
--
-- Estructura de tabla para la tabla `oc_product_to_store`
--
...
--
-- Volcado de datos para la tabla `oc_product_to_store`
--
...
--
-- Estructura de tabla para la tabla `oc_product_viewed`
--
...
--
-- Estructura de tabla para la tabla `oc_return`
--
...
--
-- Estructura de tabla para la tabla `oc_return_action`
--
...
--
-- Volcado de datos para la tabla `oc_return_action`
--
...
--
-- Estructura de tabla para la tabla `oc_return_history`
--
...
--
-- Estructura de tabla para la tabla `oc_return_reason`
--
...
--
-- Volcado de datos para la tabla `oc_return_reason`
--
...
--
-- Estructura de tabla para la tabla `oc_return_status`
--
...
--
-- Volcado de datos para la tabla `oc_return_status`
--
...
--
-- Estructura de tabla para la tabla `oc_review`
--
...
--
-- Estructura de tabla para la tabla `oc_seo_url`
--
...
--
-- Volcado de datos para la tabla `oc_seo_url`
--

INSERT INTO `oc_seo_url` (`seo_url_id`, `store_id`, `language_id`, `key`, `value`, `keyword`, `sort_order`) VALUES
(101, 0, 2, 'product_id', '32', 'ipod-touch', 1),
(103, 0, 2, 'manufacturer_id', '5', 'htc', 0),
(104, 0, 2, 'manufacturer_id', '7', 'hewlett-packard', 0),
(105, 0, 2, 'manufacturer_id', '6', 'palm', 0),
(106, 0, 2, 'manufacturer_id', '10', 'sony', 0),
(107, 0, 2, 'manufacturer_id', '9', 'canon', 0),
(108, 0, 2, 'manufacturer_id', '8', 'apple', 0),
(109, 0, 2, 'path', '30', 'printer', 0),
(147, 0, 2, 'information_id', '1', 'about-us', 0),
(148, 0, 2, 'information_id', '2', 'terms', 0),
(149, 0, 2, 'information_id', '4', 'delivery', 0),
(150, 0, 2, 'information_id', '3', 'privacy', 0),
(151, 0, 2, 'language', 'en-gb', 'en-gb', -2),
(152, 0, 2, 'route', 'information/information.info', 'info', 0),
(153, 0, 2, 'route', 'information/information', 'information', -1),
(154, 0, 2, 'route', 'product/product', 'product', -1),
(155, 0, 2, 'route', 'product/category', 'catalog', -1),
(156, 0, 2, 'route', 'product/manufacturer', 'brands', -1),
(159, 0, 2, 'product_id', '28', 'htc-touch-hd', 0),
(162, 0, 2, 'product_id', '30', 'canon-eos-5d', 0),
(165, 0, 2, 'path', '60', '111f222', 0),
(166, 0, 2, 'product_id', '43', 'macbook', 0),
(167, 0, 2, 'product_id', '47', 'hp-lp3065', 0),
(168, 0, 2, 'product_id', '42', 'apple-cinema', 0),
(171, 0, 2, 'product_id', '44', 'macbook-air', 0),
(172, 0, 2, 'product_id', '46', 'sony-vaio', 0),
(173, 0, 2, 'product_id', '35', 'product-8', 0),
(175, 0, 2, 'product_id', '50', '111f23', 0),
(176, 0, 2, 'path', '61', '11122rr', 0),
(178, 0, 2, 'product_id', '40', 'iphone', 0),
(179, 0, 2, 'product_id', '48', 'ipod-classic', 0),
(180, 0, 2, 'product_id', '41', 'imac', 0),
(181, 0, 2, 'product_id', '36', 'ipod-nano', 0),
(182, 0, 2, 'product_id', '34', 'ipod-shuffle', 0),
(185, 0, 2, 'product_id', '52', 'sss22', 0),
(187, 0, 2, 'path', '62', '224fff', 0),
(189, 0, 2, 'product_id', '53', 'ss2211', 0),
(190, 0, 2, 'product_id', '51', 'ss2ssa', 0),
(192, 0, 2, 'product_id', '54', '1122ss', 0),
(193, 0, 2, 'product_id', '55', 'ss2211s', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_session`
--
...
--
-- Volcado de datos para la tabla `oc_session`
--

INSERT INTO `oc_session` (`session_id`, `data`, `expire`) VALUES
('08df52ba8ba33ff797c478b9d1', '{\"user_id\":\"1\",\"user_token\":\"80fb7481b9ed031f1495b2750863b6ae\"}', '2024-05-15 17:56:40'),
('2c469ffd3c8f63a347fce13332', '{\"currency\":\"MXN\",\"review_token\":\"7ed1e5f801ab71245cedb7eb2a04bb2a\"}', '2024-05-15 19:21:47'),
('69fcb5018a1df44cc85ea8cbf2', '{\"currency\":\"USD\"}', '2024-06-14 19:33:35'),
('a79c11cc55357129c8045866ae', '{\"user_id\":\"1\",\"user_token\":\"da741c2d179df7c4e9df843d8c21c289\"}', '2024-05-14 17:06:21');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_setting`
--
...
--
-- Volcado de datos para la tabla `oc_setting`
--
...
(616, 0, 'config', 'config_meta_title', 'MikesSHoop', 0),
(617, 0, 'config', 'config_meta_description', 'My Store', 0),
(618, 0, 'config', 'config_meta_keyword', '', 0),
(619, 0, 'config', 'config_logo', 'catalog/8957590427_017284ab-3936-465f-a980-e4fe67af5e43.png', 0),
(620, 0, 'config', 'config_theme', 'basic', 0),
(621, 0, 'config', 'config_layout_id', '4', 0),
(622, 0, 'config', 'config_name', 'Your Store', 0),
(623, 0, 'config', 'config_owner', 'Your Name', 0),
(624, 0, 'config', 'config_address', 'Address 1', 0),
(625, 0, 'config', 'config_geocode', '', 0),
(626, 0, 'config', 'config_email', 'mr8942734@gmail.com', 0),
(627, 0, 'config', 'config_telephone', '123456789', 0),
(628, 0, 'config', 'config_image', 'catalog/cart.png', 0),
(629, 0, 'config', 'config_open', '', 0),
(630, 0, 'config', 'config_comment', '', 0),
(631, 0, 'config', 'config_country_id', '138', 0),
(632, 0, 'config', 'config_zone_id', '2160', 0),
(633, 0, 'config', 'config_timezone', 'America/Mexico_City', 0),
(634, 0, 'config', 'config_language', 'es-es', 0),
(635, 0, 'config', 'config_language_admin', 'es-es', 0),
(636, 0, 'config', 'config_currency', 'USD', 0),
(637, 0, 'config', 'config_currency_engine', 'ecb', 0),
(638, 0, 'config', 'config_currency_auto', '1', 0),
(639, 0, 'config', 'config_length_class_id', '1', 0),
(640, 0, 'config', 'config_weight_class_id', '1', 0),
(641, 0, 'config', 'config_product_description_length', '100', 0),
(642, 0, 'config', 'config_pagination', '10', 0),
(643, 0, 'config', 'config_product_count', '1', 0),
(644, 0, 'config', 'config_pagination_admin', '10', 0),
(645, 0, 'config', 'config_product_report_status', '0', 0),
(646, 0, 'config', 'config_review_status', '1', 0),
(647, 0, 'config', 'config_review_purchased', '0', 0),
(648, 0, 'config', 'config_review_guest', '1', 0),
(649, 0, 'config', 'config_article_description_length', '90', 0),
(650, 0, 'config', 'config_comment_status', '0', 0),
(651, 0, 'config', 'config_comment_guest', '0', 0),
(652, 0, 'config', 'config_voucher_min', '1', 0),
(653, 0, 'config', 'config_voucher_max', '1000', 0),
(654, 0, 'config', 'config_cookie_id', '0', 0),
(655, 0, 'config', 'config_gdpr_id', '0', 0),
(656, 0, 'config', 'config_gdpr_limit', '180', 0),
(657, 0, 'config', 'config_tax', '1', 0),
(658, 0, 'config', 'config_tax_default', 'shipping', 0),
(659, 0, 'config', 'config_tax_customer', 'shipping', 0),
(660, 0, 'config', 'config_customer_online', '0', 0),
(661, 0, 'config', 'config_customer_online_expire', '1', 0),
(662, 0, 'config', 'config_customer_activity', '0', 0),
(663, 0, 'config', 'config_customer_search', '0', 0),
(664, 0, 'config', 'config_customer_group_id', '1', 0),
(665, 0, 'config', 'config_customer_group_display', '[\"1\"]', 1),
(666, 0, 'config', 'config_customer_price', '0', 0),
(667, 0, 'config', 'config_telephone_display', '0', 0),
(668, 0, 'config', 'config_telephone_required', '0', 0),
(669, 0, 'config', 'config_login_attempts', '5', 0),
(670, 0, 'config', 'config_account_id', '3', 0),
(671, 0, 'config', 'config_invoice_prefix', 'INV-2024-00', 0),
(672, 0, 'config', 'config_cart_weight', '1', 0),
(673, 0, 'config', 'config_checkout_guest', '1', 0),
(674, 0, 'config', 'config_checkout_payment_address', '0', 0),
(675, 0, 'config', 'config_checkout_shipping_address', '0', 0),
(676, 0, 'config', 'config_checkout_id', '0', 0),
(677, 0, 'config', 'config_order_status_id', '1', 0),
(678, 0, 'config', 'config_processing_status', '[\"5\",\"1\",\"2\",\"12\",\"3\"]', 1),
(679, 0, 'config', 'config_complete_status', '[\"5\",\"3\"]', 1),
(680, 0, 'config', 'config_fraud_status_id', '8', 0),
(681, 0, 'config', 'config_api_id', '1', 0),
(682, 0, 'config', 'config_subscription_status_id', '1', 0),
(683, 0, 'config', 'config_subscription_active_status_id', '2', 0),
(684, 0, 'config', 'config_subscription_expired_status_id', '3', 0),
(685, 0, 'config', 'config_subscription_suspended_status_id', '4', 0),
(686, 0, 'config', 'config_subscription_canceled_status_id', '5', 0),
(687, 0, 'config', 'config_subscription_failed_status_id', '6', 0),
(688, 0, 'config', 'config_subscription_denied_status_id', '7', 0),
(689, 0, 'config', 'config_stock_display', '0', 0),
(690, 0, 'config', 'config_stock_warning', '0', 0),
(691, 0, 'config', 'config_stock_checkout', '0', 0),
(692, 0, 'config', 'config_affiliate_status', '1', 0),
(693, 0, 'config', 'config_affiliate_group_id', '1', 0),
(694, 0, 'config', 'config_affiliate_approval', '0', 0),
(695, 0, 'config', 'config_affiliate_auto', '0', 0),
(696, 0, 'config', 'config_affiliate_commission', '5', 0),
(697, 0, 'config', 'config_affiliate_expire', '0', 0),
(698, 0, 'config', 'config_affiliate_id', '4', 0),
(699, 0, 'config', 'config_return_status_id', '2', 0),
(700, 0, 'config', 'config_return_id', '0', 0),
(701, 0, 'config', 'config_captcha', '', 0),
(702, 0, 'config', 'config_captcha_page', '[\"review\",\"contact\"]', 1),
(703, 0, 'config', 'config_image_category_width', '80', 0),
(704, 0, 'config', 'config_image_category_height', '80', 0),
(705, 0, 'config', 'config_image_thumb_width', '500', 0),
(706, 0, 'config', 'config_image_thumb_height', '500', 0),
(707, 0, 'config', 'config_image_popup_width', '800', 0),
(708, 0, 'config', 'config_image_popup_height', '800', 0),
(709, 0, 'config', 'config_image_product_width', '250', 0),
(710, 0, 'config', 'config_image_product_height', '250', 0),
(711, 0, 'config', 'config_image_additional_width', '74', 0),
(712, 0, 'config', 'config_image_additional_height', '74', 0),
(713, 0, 'config', 'config_image_related_width', '250', 0),
(714, 0, 'config', 'config_image_related_height', '250', 0),
(715, 0, 'config', 'config_image_blog_width', '90', 0),
(716, 0, 'config', 'config_image_blog_height', '90', 0),
(717, 0, 'config', 'config_image_compare_width', '90', 0),
(718, 0, 'config', 'config_image_compare_height', '90', 0),
(719, 0, 'config', 'config_image_wishlist_width', '47', 0),
(720, 0, 'config', 'config_image_wishlist_height', '47', 0),
(721, 0, 'config', 'config_image_cart_width', '47', 0),
(722, 0, 'config', 'config_image_cart_height', '47', 0),
(723, 0, 'config', 'config_image_location_width', '268', 0),
(724, 0, 'config', 'config_image_location_height', '50', 0),
(725, 0, 'config', 'config_mail_engine', '', 0),
(726, 0, 'config', 'config_mail_parameter', '', 0),
(727, 0, 'config', 'config_mail_smtp_hostname', '', 0),
(728, 0, 'config', 'config_mail_smtp_username', '', 0),
(729, 0, 'config', 'config_mail_smtp_password', '', 0),
(730, 0, 'config', 'config_mail_smtp_port', '25', 0),
(731, 0, 'config', 'config_mail_smtp_timeout', '5', 0),
(732, 0, 'config', 'config_mail_alert', '[\"order\"]', 1),
(733, 0, 'config', 'config_mail_alert_email', '', 0),
(734, 0, 'config', 'config_maintenance', '0', 0),
(735, 0, 'config', 'config_session_expire', '86400', 0),
(736, 0, 'config', 'config_session_samesite', 'Strict', 0),
(737, 0, 'config', 'config_seo_url', '0', 0),
(738, 0, 'config', 'config_robots', 'abot\r\ndbot\r\nebot\r\nhbot\r\nkbot\r\nlbot\r\nmbot\r\nnbot\r\nobot\r\npbot\r\nrbot\r\nsbot\r\ntbot\r\nvbot\r\nybot\r\nzbot\r\nbot.\r\nbot/\r\n_bot\r\n.bot\r\n/bot\r\n-bot\r\n:bot\r\n(bot\r\ncrawl\r\nslurp\r\nspider\r\nseek\r\naccoona\r\nacoon\r\nadressendeutschland\r\nah-ha.com\r\nahoy\r\naltavista\r\nananzi\r\nanthill\r\nappie\r\narachnophilia\r\narale\r\naraneo\r\naranha\r\narchitext\r\naretha\r\narks\r\nasterias\r\natlocal\r\natn\r\natomz\r\naugurfind\r\nbackrub\r\nbannana_bot\r\nbaypup\r\nbdfetch\r\nbig brother\r\nbiglotron\r\nbjaaland\r\nblackwidow\r\nblaiz\r\nblog\r\nblo.\r\nbloodhound\r\nboitho\r\nbooch\r\nbradley\r\nbutterfly\r\ncalif\r\ncassandra\r\nccubee\r\ncfetch\r\ncharlotte\r\nchurl\r\ncienciaficcion\r\ncmc\r\ncollective\r\ncomagent\r\ncombine\r\ncomputingsite\r\ncsci\r\ncurl\r\ncusco\r\ndaumoa\r\ndeepindex\r\ndelorie\r\ndepspid\r\ndeweb\r\ndie blinde kuh\r\ndigger\r\nditto\r\ndmoz\r\ndocomo\r\ndownload express\r\ndtaagent\r\ndwcp\r\nebiness\r\nebingbong\r\ne-collector\r\nejupiter\r\nemacs-w3 search engine\r\nesther\r\nevliya celebi\r\nezresult\r\nfalcon\r\nfelix ide\r\nferret\r\nfetchrover\r\nfido\r\nfindlinks\r\nfireball\r\nfish search\r\nfouineur\r\nfunnelweb\r\ngazz\r\ngcreep\r\ngenieknows\r\ngetterroboplus\r\ngeturl\r\nglx\r\ngoforit\r\ngolem\r\ngrabber\r\ngrapnel\r\ngralon\r\ngriffon\r\ngromit\r\ngrub\r\ngulliver\r\nhamahakki\r\nharvest\r\nhavindex\r\nhelix\r\nheritrix\r\nhku www octopus\r\nhomerweb\r\nhtdig\r\nhtml index\r\nhtml_analyzer\r\nhtmlgobble\r\nhubater\r\nhyper-decontextualizer\r\nia_archiver\r\nibm_planetwide\r\nichiro\r\niconsurf\r\niltrovatore\r\nimage.kapsi.net\r\nimagelock\r\nincywincy\r\nindexer\r\ninfobee\r\ninformant\r\ningrid\r\ninktomisearch.com\r\ninspector web\r\nintelliagent\r\ninternet shinchakubin\r\nip3000\r\niron33\r\nisraeli-search\r\nivia\r\njack\r\njakarta\r\njavabee\r\njetbot\r\njumpstation\r\nkatipo\r\nkdd-explorer\r\nkilroy\r\nknowledge\r\nkototoi\r\nkretrieve\r\nlabelgrabber\r\nlachesis\r\nlarbin\r\nlegs\r\nlibwww\r\nlinkalarm\r\nlink validator\r\nlinkscan\r\nlockon\r\nlwp\r\nlycos\r\nmagpie\r\nmantraagent\r\nmapoftheinternet\r\nmarvin/\r\nmattie\r\nmediafox\r\nmediapartners\r\nmercator\r\nmerzscope\r\nmicrosoft url control\r\nminirank\r\nmiva\r\nmj12\r\nmnogosearch\r\nmoget\r\nmonster\r\nmoose\r\nmotor\r\nmultitext\r\nmuncher\r\nmuscatferret\r\nmwd.search\r\nmyweb\r\nnajdi\r\nnameprotect\r\nnationaldirectory\r\nnazilla\r\nncsa beta\r\nnec-meshexplorer\r\nnederland.zoek\r\nnetcarta webmap engine\r\nnetmechanic\r\nnetresearchserver\r\nnetscoop\r\nnewscan-online\r\nnhse\r\nnokia6682/\r\nnomad\r\nnoyona\r\nnutch\r\nnzexplorer\r\nobjectssearch\r\noccam\r\nomni\r\nopen text\r\nopenfind\r\nopenintelligencedata\r\norb search\r\nosis-project\r\npack rat\r\npageboy\r\npagebull\r\npage_verifier\r\npanscient\r\nparasite\r\npartnersite\r\npatric\r\npear.\r\npegasus\r\nperegrinator\r\npgp key agent\r\nphantom\r\nphpdig\r\npicosearch\r\npiltdownman\r\npimptrain\r\npinpoint\r\npioneer\r\npiranha\r\nplumtreewebaccessor\r\npogodak\r\npoirot\r\npompos\r\npoppelsdorf\r\npoppi\r\npopular iconoclast\r\npsycheclone\r\npublisher\r\npython\r\nrambler\r\nraven search\r\nroach\r\nroad runner\r\nroadhouse\r\nrobbie\r\nrobofox\r\nrobozilla\r\nrules\r\nsalty\r\nsbider\r\nscooter\r\nscoutjet\r\nscrubby\r\nsearch.\r\nsearchprocess\r\nsemanticdiscovery\r\nsenrigan\r\nsg-scout\r\nshai\'hulud\r\nshark\r\nshopwiki\r\nsidewinder\r\nsift\r\nsilk\r\nsimmany\r\nsite searcher\r\nsite valet\r\nsitetech-rover\r\nskymob.com\r\nsleek\r\nsmartwit\r\nsna-\r\nsnappy\r\nsnooper\r\nsohu\r\nspeedfind\r\nsphere\r\nsphider\r\nspinner\r\nspyder\r\nsteeler/\r\nsuke\r\nsuntek\r\nsupersnooper\r\nsurfnomore\r\nsven\r\nsygol\r\nszukacz\r\ntach black widow\r\ntarantula\r\ntempleton\r\n/teoma\r\nt-h-u-n-d-e-r-s-t-o-n-e\r\ntheophrastus\r\ntitan\r\ntitin\r\ntkwww\r\ntoutatis\r\nt-rex\r\ntutorgig\r\ntwiceler\r\ntwisted\r\nucsd\r\nudmsearch\r\nurl check\r\nupdated\r\nvagabondo\r\nvalkyrie\r\nverticrawl\r\nvictoria\r\nvision-search\r\nvolcano\r\nvoyager/\r\nvoyager-hc\r\nw3c_validator\r\nw3m2\r\nw3mir\r\nwalker\r\nwallpaper\r\nwanderer\r\nwauuu\r\nwavefire\r\nweb core\r\nweb hopper\r\nweb wombat\r\nwebbandit\r\nwebcatcher\r\nwebcopy\r\nwebfoot\r\nweblayers\r\nweblinker\r\nweblog monitor\r\nwebmirror\r\nwebmonkey\r\nwebquest\r\nwebreaper\r\nwebsitepulse\r\nwebsnarf\r\nwebstolperer\r\nwebvac\r\nwebwalk\r\nwebwatch\r\nwebwombat\r\nwebzinger\r\nwhizbang\r\nwhowhere\r\nwild ferret\r\nworldlight\r\nwwwc\r\nwwwster\r\nxenu\r\nxget\r\nxift\r\nxirq\r\nyandex\r\nyanga\r\nyeti\r\nyodao\r\nzao\r\nzippp\r\nzyborg', 0),
(739, 0, 'config', 'config_compression', '0', 0),
(740, 0, 'config', 'config_security', '0', 0),
(741, 0, 'config', 'config_shared', '0', 0),
(742, 0, 'config', 'config_encryption', '', 0),
(743, 0, 'config', 'config_file_max_size', '20', 0),
(744, 0, 'config', 'config_file_ext_allowed', 'zip\r\ntxt\r\npng\r\njpe\r\njpeg\r\nwebp\r\njpg\r\ngif\r\nbmp\r\nico\r\ntiff\r\ntif\r\nsvg\r\nsvgz\r\nzip\r\nrar\r\nmsi\r\ncab\r\nmp3\r\nmp4\r\nqt\r\nmov\r\npdf\r\npsd\r\nai\r\neps\r\nps\r\ndoc', 0),
(745, 0, 'config', 'config_file_mime_allowed', 'text/plain\r\nimage/png\r\nimage/webp\r\nimage/jpeg\r\nimage/gif\r\nimage/bmp\r\nimage/tiff\r\nimage/svg+xml\r\napplication/zip\r\napplication/x-zip\r\napplication/x-zip-compressed\r\napplication/rar\r\napplication/x-rar\r\napplication/x-rar-compressed\r\napplication/octet-stream\r\naudio/mpeg\r\nvideo/mp4\r\nvideo/quicktime\r\napplication/pdf', 0),
(746, 0, 'config', 'config_error_display', '1', 0),
(747, 0, 'config', 'config_error_log', '1', 0),
(748, 0, 'config', 'config_error_filename', 'error.log', 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_startup`
--
...
--
-- Estructura de tabla para la tabla `oc_statistics`
--
...
--
-- Volcado de datos para la tabla `oc_statistics`
--
...
--
-- Estructura de tabla para la tabla `oc_stock_status`
--
...
--
-- Volcado de datos para la tabla `oc_stock_status`
--
...
--
-- Estructura de tabla para la tabla `oc_store`
--
...
--
-- Estructura de tabla para la tabla `oc_subscription`
--
...
--
-- Estructura de tabla para la tabla `oc_subscription_history`
--
...
--
-- Estructura de tabla para la tabla `oc_subscription_plan`
--
...
--
-- Volcado de datos para la tabla `oc_subscription_plan`
--
...
--
-- Estructura de tabla para la tabla `oc_subscription_plan_description`
--
...
--
-- Volcado de datos para la tabla `oc_subscription_plan_description`
--
...
--
-- Estructura de tabla para la tabla `oc_subscription_status`
--
...
--
-- Volcado de datos para la tabla `oc_subscription_status`
--
...
--
-- Estructura de tabla para la tabla `oc_tax_class`
--
...
--
-- Volcado de datos para la tabla `oc_tax_class`
--
...
--
-- Estructura de tabla para la tabla `oc_tax_rate`
--
...
--
-- Volcado de datos para la tabla `oc_tax_rate`
--
...
--
-- Estructura de tabla para la tabla `oc_tax_rate_to_customer_group`
--
...
--
-- Volcado de datos para la tabla `oc_tax_rate_to_customer_group`
--
...
--
-- Estructura de tabla para la tabla `oc_tax_rule`
--
...
--
-- Volcado de datos para la tabla `oc_tax_rule`
--
...
--
-- Estructura de tabla para la tabla `oc_theme`
--
...
--
-- Estructura de tabla para la tabla `oc_topic`
--
...
--
-- Estructura de tabla para la tabla `oc_topic_description`
--
...
--
-- Estructura de tabla para la tabla `oc_topic_to_store`
--
...
--
-- Estructura de tabla para la tabla `oc_translation`
--
...
--
-- Estructura de tabla para la tabla `oc_upload`
--
...
(1, 1, 'admin', '$2y$10$KOItA3jPiij8fJY.Qqwaj.e4S.uAd4bOyH.zDAOKcGKv3FFZHQwyq', 'John', 'Doe', 'mr8942734@gmail.com', '', '', '::1', 1, '2024-05-09 14:59:44');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_user_authorize`
--
...
--
-- Volcado de datos para la tabla `oc_user_login`
--

INSERT INTO `oc_user_login` (`user_login_id`, `user_id`, `ip`, `user_agent`, `date_added`) VALUES
(1, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36', '2024-05-09 14:59:55'),
(2, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36', '2024-05-09 11:22:22'),
(3, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36', '2024-05-09 15:28:20'),
(4, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36', '2024-05-09 16:38:33'),
(5, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36 Edg/124.0.0.0', '2024-05-09 16:38:44'),
(6, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36', '2024-05-13 08:22:58'),
(7, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36 Edg/124.0.0.0', '2024-05-13 08:33:48'),
(8, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36', '2024-05-13 08:40:27'),
(9, 1, '::1', 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/124.0.0.0 Safari/537.36', '2024-05-14 10:28:17');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `oc_voucher`
--
...
--
-- Estructura de tabla para la tabla `oc_voucher_history`
--
...
--
-- Estructura de tabla para la tabla `oc_voucher_theme`
--
...
--
-- Volcado de datos para la tabla `oc_voucher_theme`
--
...
--
-- Estructura de tabla para la tabla `oc_voucher_theme_description`
--
...
--
-- Volcado de datos para la tabla `oc_voucher_theme_description`
--
...
--
-- Estructura de tabla para la tabla `oc_weight_class`
--
...
--
-- Volcado de datos para la tabla `oc_weight_class`
--
...
--
-- Estructura de tabla para la tabla `oc_weight_class_description`
--
...
--
-- Volcado de datos para la tabla `oc_weight_class_description`
--
...
--
-- Estructura de tabla para la tabla `oc_zone`
--
...
--
-- Volcado de datos para la tabla `oc_zone`
--
...
--
-- Estructura de tabla para la tabla `oc_zone_to_geo_zone`
--
...
--
-- Volcado de datos para la tabla `oc_zone_to_geo_zone`
--
...
--
-- Indices de la tabla `oc_address`
--
...
--
-- Indices de la tabla `oc_address_format`
--
ALTER TABLE `oc_address_format`
  ADD PRIMARY KEY (`address_format_id`);

--
-- Indices de la tabla `oc_antispam`
--
...
--
-- Indices de la tabla `oc_api`
--
ALTER TABLE `oc_api`
  ADD PRIMARY KEY (`api_id`);

--
-- Indices de la tabla `oc_api_ip`
--
ALTER TABLE `oc_api_ip`
  ADD PRIMARY KEY (`api_ip_id`);

--
-- Indices de la tabla `oc_api_session`
--
ALTER TABLE `oc_api_session`
  ADD PRIMARY KEY (`api_session_id`);

--
-- Indices de la tabla `oc_article`
--
ALTER TABLE `oc_article`
  ADD PRIMARY KEY (`article_id`);

--
-- Indices de la tabla `oc_article_comment`
--
...
--
-- Indices de la tabla `oc_article_description`
--
...
--
-- Indices de la tabla `oc_article_to_layout`
--
ALTER TABLE `oc_article_to_layout`
  ADD PRIMARY KEY (`article_id`,`store_id`);

--
-- Indices de la tabla `oc_article_to_store`
--
ALTER TABLE `oc_article_to_store`
  ADD PRIMARY KEY (`article_id`,`store_id`);

--
-- Indices de la tabla `oc_attribute`
--
ALTER TABLE `oc_attribute`
  ADD PRIMARY KEY (`attribute_id`);

--
-- Indices de la tabla `oc_attribute_description`
--
ALTER TABLE `oc_attribute_description`
  ADD PRIMARY KEY (`attribute_id`,`language_id`);

--
-- Indices de la tabla `oc_attribute_group`
--
ALTER TABLE `oc_attribute_group`
  ADD PRIMARY KEY (`attribute_group_id`);

--
-- Indices de la tabla `oc_attribute_group_description`
--
ALTER TABLE `oc_attribute_group_description`
  ADD PRIMARY KEY (`attribute_group_id`,`language_id`);

--
-- Indices de la tabla `oc_banner`
--
ALTER TABLE `oc_banner`
  ADD PRIMARY KEY (`banner_id`);

--
-- Indices de la tabla `oc_banner_image`
--
ALTER TABLE `oc_banner_image`
  ADD PRIMARY KEY (`banner_image_id`);

--
-- Indices de la tabla `oc_cart`
--
ALTER TABLE `oc_cart`
...
--
-- Indices de la tabla `oc_category`
--
...
--
-- Indices de la tabla `oc_category_description`
--
...
--
-- Indices de la tabla `oc_category_filter`
--
ALTER TABLE `oc_category_filter`
  ADD PRIMARY KEY (`category_id`,`filter_id`);

--
-- Indices de la tabla `oc_category_path`
--
ALTER TABLE `oc_category_path`
  ADD PRIMARY KEY (`category_id`,`path_id`);

--
-- Indices de la tabla `oc_category_to_layout`
--
ALTER TABLE `oc_category_to_layout`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indices de la tabla `oc_category_to_store`
--
ALTER TABLE `oc_category_to_store`
  ADD PRIMARY KEY (`category_id`,`store_id`);

--
-- Indices de la tabla `oc_country`
--
ALTER TABLE `oc_country`
  ADD PRIMARY KEY (`country_id`);

--
-- Indices de la tabla `oc_coupon`
--
ALTER TABLE `oc_coupon`
  ADD PRIMARY KEY (`coupon_id`);

--
-- Indices de la tabla `oc_coupon_category`
--
ALTER TABLE `oc_coupon_category`
  ADD PRIMARY KEY (`coupon_id`,`category_id`);

--
-- Indices de la tabla `oc_coupon_history`
--
ALTER TABLE `oc_coupon_history`
  ADD PRIMARY KEY (`coupon_history_id`);

--
-- Indices de la tabla `oc_coupon_product`
--
ALTER TABLE `oc_coupon_product`
  ADD PRIMARY KEY (`coupon_product_id`);

--
-- Indices de la tabla `oc_cron`
--
ALTER TABLE `oc_cron`
  ADD PRIMARY KEY (`cron_id`);

--
-- Indices de la tabla `oc_currency`
--
ALTER TABLE `oc_currency`
  ADD PRIMARY KEY (`currency_id`);

--
-- Indices de la tabla `oc_customer`
--
ALTER TABLE `oc_customer`
  ADD PRIMARY KEY (`customer_id`);

--
-- Indices de la tabla `oc_customer_activity`
--
ALTER TABLE `oc_customer_activity`
  ADD PRIMARY KEY (`customer_activity_id`);

--
-- Indices de la tabla `oc_customer_affiliate`
--
ALTER TABLE `oc_customer_affiliate`
  ADD PRIMARY KEY (`customer_id`);

--
-- Indices de la tabla `oc_customer_affiliate_report`
--
ALTER TABLE `oc_customer_affiliate_report`
  ADD PRIMARY KEY (`customer_affiliate_report_id`);

--
-- Indices de la tabla `oc_customer_approval`
--
ALTER TABLE `oc_customer_approval`
  ADD PRIMARY KEY (`customer_approval_id`);

--
-- Indices de la tabla `oc_customer_group`
--
ALTER TABLE `oc_customer_group`
  ADD PRIMARY KEY (`customer_group_id`);

--
-- Indices de la tabla `oc_customer_group_description`
--
ALTER TABLE `oc_customer_group_description`
  ADD PRIMARY KEY (`customer_group_id`,`language_id`);

--
-- Indices de la tabla `oc_customer_history`
--
ALTER TABLE `oc_customer_history`
  ADD PRIMARY KEY (`customer_history_id`);

--
-- Indices de la tabla `oc_customer_ip`
--
...
--
-- Indices de la tabla `oc_customer_login`
--
...
--
-- Indices de la tabla `oc_customer_online`
--
ALTER TABLE `oc_customer_online`
  ADD PRIMARY KEY (`ip`);

--
-- Indices de la tabla `oc_customer_reward`
--
ALTER TABLE `oc_customer_reward`
  ADD PRIMARY KEY (`customer_reward_id`);

--
-- Indices de la tabla `oc_customer_search`
--
ALTER TABLE `oc_customer_search`
  ADD PRIMARY KEY (`customer_search_id`);

--
-- Indices de la tabla `oc_customer_transaction`
--
ALTER TABLE `oc_customer_transaction`
  ADD PRIMARY KEY (`customer_transaction_id`);

--
-- Indices de la tabla `oc_customer_wishlist`
--
ALTER TABLE `oc_customer_wishlist`
  ADD PRIMARY KEY (`customer_id`,`product_id`);

--
-- Indices de la tabla `oc_custom_field`
--
ALTER TABLE `oc_custom_field`
  ADD PRIMARY KEY (`custom_field_id`);

--
-- Indices de la tabla `oc_custom_field_customer_group`
--
ALTER TABLE `oc_custom_field_customer_group`
  ADD PRIMARY KEY (`custom_field_id`,`customer_group_id`);

--
-- Indices de la tabla `oc_custom_field_description`
--
ALTER TABLE `oc_custom_field_description`
  ADD PRIMARY KEY (`custom_field_id`,`language_id`);

--
-- Indices de la tabla `oc_custom_field_value`
--
ALTER TABLE `oc_custom_field_value`
  ADD PRIMARY KEY (`custom_field_value_id`);

--
-- Indices de la tabla `oc_custom_field_value_description`
--
ALTER TABLE `oc_custom_field_value_description`
  ADD PRIMARY KEY (`custom_field_value_id`,`language_id`);

--
-- Indices de la tabla `oc_download`
--
ALTER TABLE `oc_download`
  ADD PRIMARY KEY (`download_id`);

--
-- Indices de la tabla `oc_download_description`
--
ALTER TABLE `oc_download_description`
  ADD PRIMARY KEY (`download_id`,`language_id`);

--
-- Indices de la tabla `oc_download_report`
--
ALTER TABLE `oc_download_report`
  ADD PRIMARY KEY (`download_report_id`);

--
-- Indices de la tabla `oc_event`
--
ALTER TABLE `oc_event`
  ADD PRIMARY KEY (`event_id`);

--
-- Indices de la tabla `oc_extension`
--
ALTER TABLE `oc_extension`
  ADD PRIMARY KEY (`extension_id`);

--
-- Indices de la tabla `oc_extension_install`
--
ALTER TABLE `oc_extension_install`
  ADD PRIMARY KEY (`extension_install_id`);

--
-- Indices de la tabla `oc_extension_path`
--
...
--
-- Indices de la tabla `oc_filter`
--
ALTER TABLE `oc_filter`
  ADD PRIMARY KEY (`filter_id`);

--
-- Indices de la tabla `oc_filter_description`
--
ALTER TABLE `oc_filter_description`
  ADD PRIMARY KEY (`filter_id`,`language_id`);

--
-- Indices de la tabla `oc_filter_group`
--
ALTER TABLE `oc_filter_group`
  ADD PRIMARY KEY (`filter_group_id`);

--
-- Indices de la tabla `oc_filter_group_description`
--
ALTER TABLE `oc_filter_group_description`
  ADD PRIMARY KEY (`filter_group_id`,`language_id`);

--
-- Indices de la tabla `oc_gdpr`
--
ALTER TABLE `oc_gdpr`
  ADD PRIMARY KEY (`gdpr_id`);

--
-- Indices de la tabla `oc_geo_zone`
--
ALTER TABLE `oc_geo_zone`
  ADD PRIMARY KEY (`geo_zone_id`);

--
-- Indices de la tabla `oc_information`
--
ALTER TABLE `oc_information`
  ADD PRIMARY KEY (`information_id`);

--
-- Indices de la tabla `oc_information_description`
--
ALTER TABLE `oc_information_description`
  ADD PRIMARY KEY (`information_id`,`language_id`);

--
-- Indices de la tabla `oc_information_to_layout`
--
ALTER TABLE `oc_information_to_layout`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Indices de la tabla `oc_information_to_store`
--
ALTER TABLE `oc_information_to_store`
  ADD PRIMARY KEY (`information_id`,`store_id`);

--
-- Indices de la tabla `oc_language`
--
...
--
-- Indices de la tabla `oc_layout`
--
ALTER TABLE `oc_layout`
  ADD PRIMARY KEY (`layout_id`);

--
-- Indices de la tabla `oc_layout_module`
--
ALTER TABLE `oc_layout_module`
  ADD PRIMARY KEY (`layout_module_id`);

--
-- Indices de la tabla `oc_layout_route`
--
ALTER TABLE `oc_layout_route`
  ADD PRIMARY KEY (`layout_route_id`);

--
-- Indices de la tabla `oc_length_class`
--
ALTER TABLE `oc_length_class`
  ADD PRIMARY KEY (`length_class_id`);

--
-- Indices de la tabla `oc_length_class_description`
--
ALTER TABLE `oc_length_class_description`
  ADD PRIMARY KEY (`length_class_id`,`language_id`);

--
-- Indices de la tabla `oc_location`
--
...
--
-- Indices de la tabla `oc_manufacturer`
--
ALTER TABLE `oc_manufacturer`
  ADD PRIMARY KEY (`manufacturer_id`);

--
-- Indices de la tabla `oc_manufacturer_to_layout`
--
ALTER TABLE `oc_manufacturer_to_layout`
  ADD PRIMARY KEY (`manufacturer_id`,`store_id`);

--
-- Indices de la tabla `oc_manufacturer_to_store`
--
ALTER TABLE `oc_manufacturer_to_store`
  ADD PRIMARY KEY (`manufacturer_id`,`store_id`);

--
-- Indices de la tabla `oc_marketing`
--
ALTER TABLE `oc_marketing`
  ADD PRIMARY KEY (`marketing_id`);

--
-- Indices de la tabla `oc_marketing_report`
--
ALTER TABLE `oc_marketing_report`
  ADD PRIMARY KEY (`marketing_report_id`);

--
-- Indices de la tabla `oc_module`
--
ALTER TABLE `oc_module`
  ADD PRIMARY KEY (`module_id`);

--
-- Indices de la tabla `oc_notification`
--
ALTER TABLE `oc_notification`
  ADD PRIMARY KEY (`notification_id`);

--
-- Indices de la tabla `oc_option`
--
ALTER TABLE `oc_option`
  ADD PRIMARY KEY (`option_id`);

--
-- Indices de la tabla `oc_option_description`
--
ALTER TABLE `oc_option_description`
  ADD PRIMARY KEY (`option_id`,`language_id`);

--
-- Indices de la tabla `oc_option_value`
--
ALTER TABLE `oc_option_value`
  ADD PRIMARY KEY (`option_value_id`);

--
-- Indices de la tabla `oc_option_value_description`
--
ALTER TABLE `oc_option_value_description`
  ADD PRIMARY KEY (`option_value_id`,`language_id`);

--
-- Indices de la tabla `oc_order`
--
ALTER TABLE `oc_order`
  ADD PRIMARY KEY (`order_id`);

--
-- Indices de la tabla `oc_order_history`
--
ALTER TABLE `oc_order_history`
  ADD PRIMARY KEY (`order_history_id`);

--
-- Indices de la tabla `oc_order_option`
--
ALTER TABLE `oc_order_option`
  ADD PRIMARY KEY (`order_option_id`);

--
-- Indices de la tabla `oc_order_product`
--
...
--
-- Indices de la tabla `oc_order_status`
--
ALTER TABLE `oc_order_status`
  ADD PRIMARY KEY (`order_status_id`,`language_id`);

--
-- Indices de la tabla `oc_order_subscription`
--
...
--
-- Indices de la tabla `oc_order_total`
--
...
--
-- Indices de la tabla `oc_order_voucher`
--
ALTER TABLE `oc_order_voucher`
  ADD PRIMARY KEY (`order_voucher_id`);

--
-- Indices de la tabla `oc_product`
--
ALTER TABLE `oc_product`
  ADD PRIMARY KEY (`product_id`);

--
-- Indices de la tabla `oc_product_attribute`
--
ALTER TABLE `oc_product_attribute`
  ADD PRIMARY KEY (`product_id`,`attribute_id`,`language_id`);

--
-- Indices de la tabla `oc_product_description`
--
...
--
-- Indices de la tabla `oc_product_discount`
--
...
--
-- Indices de la tabla `oc_product_filter`
--
ALTER TABLE `oc_product_filter`
  ADD PRIMARY KEY (`product_id`,`filter_id`);

--
-- Indices de la tabla `oc_product_image`
--
...
--
-- Indices de la tabla `oc_product_option`
--
ALTER TABLE `oc_product_option`
  ADD PRIMARY KEY (`product_option_id`);

--
-- Indices de la tabla `oc_product_option_value`
--
ALTER TABLE `oc_product_option_value`
  ADD PRIMARY KEY (`product_option_value_id`);

--
-- Indices de la tabla `oc_product_related`
--
ALTER TABLE `oc_product_related`
  ADD PRIMARY KEY (`product_id`,`related_id`);

--
-- Indices de la tabla `oc_product_report`
--
ALTER TABLE `oc_product_report`
  ADD PRIMARY KEY (`product_report_id`);

--
-- Indices de la tabla `oc_product_reward`
--
ALTER TABLE `oc_product_reward`
  ADD PRIMARY KEY (`product_reward_id`);

--
-- Indices de la tabla `oc_product_special`
--
...
--
-- Indices de la tabla `oc_product_to_download`
--
ALTER TABLE `oc_product_to_download`
  ADD PRIMARY KEY (`product_id`,`download_id`);

--
-- Indices de la tabla `oc_product_to_layout`
--
ALTER TABLE `oc_product_to_layout`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Indices de la tabla `oc_product_to_store`
--
ALTER TABLE `oc_product_to_store`
  ADD PRIMARY KEY (`product_id`,`store_id`);

--
-- Indices de la tabla `oc_product_viewed`
--
ALTER TABLE `oc_product_viewed`
  ADD PRIMARY KEY (`product_id`);

--
-- Indices de la tabla `oc_return`
--
ALTER TABLE `oc_return`
  ADD PRIMARY KEY (`return_id`);

--
-- Indices de la tabla `oc_return_action`
--
ALTER TABLE `oc_return_action`
  ADD PRIMARY KEY (`return_action_id`,`language_id`);

--
-- Indices de la tabla `oc_return_history`
--
ALTER TABLE `oc_return_history`
  ADD PRIMARY KEY (`return_history_id`);

--
-- Indices de la tabla `oc_return_reason`
--
ALTER TABLE `oc_return_reason`
  ADD PRIMARY KEY (`return_reason_id`,`language_id`);

--
-- Indices de la tabla `oc_return_status`
--
ALTER TABLE `oc_return_status`
  ADD PRIMARY KEY (`return_status_id`,`language_id`);

--
-- Indices de la tabla `oc_review`
--
...
--
-- Indices de la tabla `oc_seo_url`
--
...
--
-- Indices de la tabla `oc_session`
--
...
--
-- Indices de la tabla `oc_setting`
--
ALTER TABLE `oc_setting`
  ADD PRIMARY KEY (`setting_id`);

--
-- Indices de la tabla `oc_startup`
--
ALTER TABLE `oc_startup`
  ADD PRIMARY KEY (`startup_id`);

--
-- Indices de la tabla `oc_statistics`
--
ALTER TABLE `oc_statistics`
  ADD PRIMARY KEY (`statistics_id`);

--
-- Indices de la tabla `oc_stock_status`
--
ALTER TABLE `oc_stock_status`
  ADD PRIMARY KEY (`stock_status_id`,`language_id`);

--
-- Indices de la tabla `oc_store`
--
ALTER TABLE `oc_store`
  ADD PRIMARY KEY (`store_id`);

--
-- Indices de la tabla `oc_subscription`
--
...
--
-- Indices de la tabla `oc_subscription_history`
--
ALTER TABLE `oc_subscription_history`
  ADD PRIMARY KEY (`subscription_history_id`);

--
-- Indices de la tabla `oc_subscription_plan`
--
ALTER TABLE `oc_subscription_plan`
  ADD PRIMARY KEY (`subscription_plan_id`);

--
-- Indices de la tabla `oc_subscription_plan_description`
--
ALTER TABLE `oc_subscription_plan_description`
  ADD PRIMARY KEY (`subscription_plan_id`,`language_id`);

--
-- Indices de la tabla `oc_subscription_status`
--
ALTER TABLE `oc_subscription_status`
  ADD PRIMARY KEY (`subscription_status_id`,`language_id`);

--
-- Indices de la tabla `oc_tax_class`
--
ALTER TABLE `oc_tax_class`
  ADD PRIMARY KEY (`tax_class_id`);

--
-- Indices de la tabla `oc_tax_rate`
--
ALTER TABLE `oc_tax_rate`
  ADD PRIMARY KEY (`tax_rate_id`);

--
-- Indices de la tabla `oc_tax_rate_to_customer_group`
--
ALTER TABLE `oc_tax_rate_to_customer_group`
  ADD PRIMARY KEY (`tax_rate_id`,`customer_group_id`);

--
-- Indices de la tabla `oc_tax_rule`
--
ALTER TABLE `oc_tax_rule`
  ADD PRIMARY KEY (`tax_rule_id`);

--
-- Indices de la tabla `oc_theme`
--
ALTER TABLE `oc_theme`
  ADD PRIMARY KEY (`theme_id`);

--
-- Indices de la tabla `oc_topic`
--
ALTER TABLE `oc_topic`
  ADD PRIMARY KEY (`topic_id`);

--
-- Indices de la tabla `oc_topic_description`
--
...
--
-- Indices de la tabla `oc_topic_to_store`
--
ALTER TABLE `oc_topic_to_store`
  ADD PRIMARY KEY (`topic_id`,`store_id`);

--
-- Indices de la tabla `oc_translation`
--
ALTER TABLE `oc_translation`
  ADD PRIMARY KEY (`translation_id`);

--
-- Indices de la tabla `oc_upload`
--
...
--
-- Indices de la tabla `oc_user_authorize`
--
...
--
-- Indices de la tabla `oc_user_login`
--
ALTER TABLE `oc_user_login`
  ADD PRIMARY KEY (`user_login_id`);

--
-- Indices de la tabla `oc_voucher`
--
ALTER TABLE `oc_voucher`
  ADD PRIMARY KEY (`voucher_id`);

--
-- Indices de la tabla `oc_voucher_history`
--
ALTER TABLE `oc_voucher_history`
  ADD PRIMARY KEY (`voucher_history_id`);

--
-- Indices de la tabla `oc_voucher_theme`
--
ALTER TABLE `oc_voucher_theme`
  ADD PRIMARY KEY (`voucher_theme_id`);

--
-- Indices de la tabla `oc_voucher_theme_description`
--
ALTER TABLE `oc_voucher_theme_description`
  ADD PRIMARY KEY (`voucher_theme_id`,`language_id`);

--
-- Indices de la tabla `oc_weight_class`
--
ALTER TABLE `oc_weight_class`
  ADD PRIMARY KEY (`weight_class_id`);

--
-- Indices de la tabla `oc_weight_class_description`
--
ALTER TABLE `oc_weight_class_description`
  ADD PRIMARY KEY (`weight_class_id`,`language_id`);

--
-- Indices de la tabla `oc_zone`
--
ALTER TABLE `oc_zone`
  ADD PRIMARY KEY (`zone_id`);

--
-- Indices de la tabla `oc_zone_to_geo_zone`
--
...
--
-- AUTO_INCREMENT de la tabla `oc_address_format`
--
ALTER TABLE `oc_address_format`
  MODIFY `address_format_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `oc_antispam`
--
ALTER TABLE `oc_antispam`
  MODIFY `antispam_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_api`
--
ALTER TABLE `oc_api`
  MODIFY `api_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `oc_api_ip`
--
ALTER TABLE `oc_api_ip`
  MODIFY `api_ip_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_api_session`
--
ALTER TABLE `oc_api_session`
  MODIFY `api_session_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_article`
--
ALTER TABLE `oc_article`
  MODIFY `article_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_article_comment`
--
ALTER TABLE `oc_article_comment`
  MODIFY `article_comment_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_attribute`
--
ALTER TABLE `oc_attribute`
  MODIFY `attribute_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT de la tabla `oc_attribute_group`
--
ALTER TABLE `oc_attribute_group`
  MODIFY `attribute_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `oc_banner`
--
ALTER TABLE `oc_banner`
  MODIFY `banner_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `oc_banner_image`
--
ALTER TABLE `oc_banner_image`
...
--
-- AUTO_INCREMENT de la tabla `oc_country`
--
ALTER TABLE `oc_country`
  MODIFY `country_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=258;

--
-- AUTO_INCREMENT de la tabla `oc_coupon`
--
ALTER TABLE `oc_coupon`
...
--
-- AUTO_INCREMENT de la tabla `oc_cron`
--
ALTER TABLE `oc_cron`
...
--
-- AUTO_INCREMENT de la tabla `oc_customer`
--
ALTER TABLE `oc_customer`
  MODIFY `customer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `oc_customer_activity`
--
ALTER TABLE `oc_customer_activity`
  MODIFY `customer_activity_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_customer_affiliate_report`
--
ALTER TABLE `oc_customer_affiliate_report`
  MODIFY `customer_affiliate_report_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_customer_approval`
--
ALTER TABLE `oc_customer_approval`
  MODIFY `customer_approval_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_customer_group`
--
ALTER TABLE `oc_customer_group`
  MODIFY `customer_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `oc_customer_history`
--
ALTER TABLE `oc_customer_history`
  MODIFY `customer_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_customer_ip`
--
ALTER TABLE `oc_customer_ip`
  MODIFY `customer_ip_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `oc_customer_login`
--
ALTER TABLE `oc_customer_login`
  MODIFY `customer_login_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_customer_reward`
--
ALTER TABLE `oc_customer_reward`
  MODIFY `customer_reward_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_customer_search`
--
ALTER TABLE `oc_customer_search`
  MODIFY `customer_search_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_customer_transaction`
--
ALTER TABLE `oc_customer_transaction`
  MODIFY `customer_transaction_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_custom_field`
--
ALTER TABLE `oc_custom_field`
  MODIFY `custom_field_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT de la tabla `oc_custom_field_value`
--
ALTER TABLE `oc_custom_field_value`
  MODIFY `custom_field_value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=47;

--
-- AUTO_INCREMENT de la tabla `oc_download`
--
ALTER TABLE `oc_download`
  MODIFY `download_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_download_report`
--
ALTER TABLE `oc_download_report`
  MODIFY `download_report_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_event`
--
ALTER TABLE `oc_event`
  MODIFY `event_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=45;

--
-- AUTO_INCREMENT de la tabla `oc_extension`
--
ALTER TABLE `oc_extension`
  MODIFY `extension_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;

--
-- AUTO_INCREMENT de la tabla `oc_extension_install`
--
ALTER TABLE `oc_extension_install`
  MODIFY `extension_install_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `oc_extension_path`
--
ALTER TABLE `oc_extension_path`
  MODIFY `extension_path_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=402;

--
-- AUTO_INCREMENT de la tabla `oc_filter`
--
ALTER TABLE `oc_filter`
  MODIFY `filter_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `oc_filter_group`
--
ALTER TABLE `oc_filter_group`
  MODIFY `filter_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT de la tabla `oc_gdpr`
--
ALTER TABLE `oc_gdpr`
  MODIFY `gdpr_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_geo_zone`
--
ALTER TABLE `oc_geo_zone`
  MODIFY `geo_zone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `oc_information`
--
ALTER TABLE `oc_information`
  MODIFY `information_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `oc_language`
--
ALTER TABLE `oc_language`
  MODIFY `language_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT de la tabla `oc_layout`
--
ALTER TABLE `oc_layout`
  MODIFY `layout_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=14;

--
-- AUTO_INCREMENT de la tabla `oc_layout_module`
--
ALTER TABLE `oc_layout_module`
  MODIFY `layout_module_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `oc_layout_route`
--
ALTER TABLE `oc_layout_route`
  MODIFY `layout_route_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=15;

--
-- AUTO_INCREMENT de la tabla `oc_length_class`
--
ALTER TABLE `oc_length_class`
  MODIFY `length_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `oc_location`
--
ALTER TABLE `oc_location`
  MODIFY `location_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_manufacturer`
--
ALTER TABLE `oc_manufacturer`
  MODIFY `manufacturer_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `oc_marketing`
--
ALTER TABLE `oc_marketing`
  MODIFY `marketing_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_marketing_report`
--
ALTER TABLE `oc_marketing_report`
  MODIFY `marketing_report_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_module`
--
ALTER TABLE `oc_module`
  MODIFY `module_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `oc_notification`
--
ALTER TABLE `oc_notification`
  MODIFY `notification_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_option`
--
ALTER TABLE `oc_option`
  MODIFY `option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=13;

--
-- AUTO_INCREMENT de la tabla `oc_option_value`
--
ALTER TABLE `oc_option_value`
...
--
-- AUTO_INCREMENT de la tabla `oc_order_status`
--
ALTER TABLE `oc_order_status`
  MODIFY `order_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `oc_order_subscription`
--
ALTER TABLE `oc_order_subscription`
...
--
-- AUTO_INCREMENT de la tabla `oc_product`
--
ALTER TABLE `oc_product`
  MODIFY `product_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=56;

--
-- AUTO_INCREMENT de la tabla `oc_product_discount`
--
ALTER TABLE `oc_product_discount`
  MODIFY `product_discount_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=453;

--
-- AUTO_INCREMENT de la tabla `oc_product_image`
--
ALTER TABLE `oc_product_image`
  MODIFY `product_image_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2398;

--
-- AUTO_INCREMENT de la tabla `oc_product_option`
--
ALTER TABLE `oc_product_option`
  MODIFY `product_option_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=227;

--
-- AUTO_INCREMENT de la tabla `oc_product_option_value`
--
ALTER TABLE `oc_product_option_value`
  MODIFY `product_option_value_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT de la tabla `oc_product_report`
--
ALTER TABLE `oc_product_report`
  MODIFY `product_report_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_product_reward`
--
ALTER TABLE `oc_product_reward`
  MODIFY `product_reward_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=562;

--
-- AUTO_INCREMENT de la tabla `oc_product_special`
--
ALTER TABLE `oc_product_special`
  MODIFY `product_special_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=448;

--
-- AUTO_INCREMENT de la tabla `oc_return`
--
ALTER TABLE `oc_return`
  MODIFY `return_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_return_action`
--
ALTER TABLE `oc_return_action`
  MODIFY `return_action_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `oc_return_history`
--
ALTER TABLE `oc_return_history`
  MODIFY `return_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_return_reason`
--
ALTER TABLE `oc_return_reason`
  MODIFY `return_reason_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;

--
-- AUTO_INCREMENT de la tabla `oc_return_status`
--
ALTER TABLE `oc_return_status`
  MODIFY `return_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `oc_review`
--
ALTER TABLE `oc_review`
  MODIFY `review_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_seo_url`
--
ALTER TABLE `oc_seo_url`
  MODIFY `seo_url_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=194;

--
-- AUTO_INCREMENT de la tabla `oc_setting`
--
ALTER TABLE `oc_setting`
  MODIFY `setting_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=749;

--
-- AUTO_INCREMENT de la tabla `oc_startup`
--
ALTER TABLE `oc_startup`
  MODIFY `startup_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_statistics`
--
ALTER TABLE `oc_statistics`
  MODIFY `statistics_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `oc_stock_status`
--
ALTER TABLE `oc_stock_status`
  MODIFY `stock_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `oc_store`
--
ALTER TABLE `oc_store`
  MODIFY `store_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_subscription`
--
ALTER TABLE `oc_subscription`
  MODIFY `subscription_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_subscription_history`
--
ALTER TABLE `oc_subscription_history`
  MODIFY `subscription_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_subscription_plan`
--
ALTER TABLE `oc_subscription_plan`
  MODIFY `subscription_plan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `oc_subscription_status`
--
ALTER TABLE `oc_subscription_status`
  MODIFY `subscription_status_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT de la tabla `oc_tax_class`
--
ALTER TABLE `oc_tax_class`
  MODIFY `tax_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;

--
-- AUTO_INCREMENT de la tabla `oc_tax_rate`
--
ALTER TABLE `oc_tax_rate`
  MODIFY `tax_rate_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=88;

--
-- AUTO_INCREMENT de la tabla `oc_tax_rule`
--
ALTER TABLE `oc_tax_rule`
  MODIFY `tax_rule_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=129;

--
-- AUTO_INCREMENT de la tabla `oc_theme`
--
ALTER TABLE `oc_theme`
  MODIFY `theme_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_topic`
--
ALTER TABLE `oc_topic`
  MODIFY `topic_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_translation`
--
ALTER TABLE `oc_translation`
  MODIFY `translation_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_upload`
--
ALTER TABLE `oc_upload`
...
--
-- AUTO_INCREMENT de la tabla `oc_user_authorize`
--
ALTER TABLE `oc_user_authorize`
...
--
-- AUTO_INCREMENT de la tabla `oc_user_login`
--
ALTER TABLE `oc_user_login`
  MODIFY `user_login_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `oc_voucher`
--
ALTER TABLE `oc_voucher`
  MODIFY `voucher_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_voucher_history`
--
ALTER TABLE `oc_voucher_history`
  MODIFY `voucher_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `oc_voucher_theme`
--
ALTER TABLE `oc_voucher_theme`
  MODIFY `voucher_theme_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT de la tabla `oc_weight_class`
--
ALTER TABLE `oc_weight_class`
  MODIFY `weight_class_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;

--
-- AUTO_INCREMENT de la tabla `oc_zone`
--
ALTER TABLE `oc_zone`
  MODIFY `zone_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4442;

--
-- AUTO_INCREMENT de la tabla `oc_zone_to_geo_zone`
--
ALTER TABLE `oc_zone_to_geo_zone`
